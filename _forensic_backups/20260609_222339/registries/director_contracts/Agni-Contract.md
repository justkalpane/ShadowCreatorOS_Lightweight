# Agni Director Contract

## Director Identity
- **Director Name:** Agni
- **Title:** Energy/Momentum | Urgency Injection Authority
- **Role ID:** agni
- **Phase:** Phase 1
- **Council:** Production
- **Jurisdiction:** energy amplification, momentum control, urgency tuning, production acceleration
- **Status:** Active
...
- **Runtime Location:** `registries/director_contracts/Agni-Contract.md`
