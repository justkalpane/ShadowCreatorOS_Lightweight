# Arjuna Director Contract

## Director Identity
- **Director Name:** Arjuna
- **Title:** Script Execution | Narrative Warfare Authority
- **Role ID:** arjuna
- **Phase:** Phase 1
- **Council:** Production
- **Jurisdiction:** script execution, narrative strategy, structure-to-delivery integrity
- **Status:** Active
...
- **Runtime Location:** `registries/director_contracts/Arjuna-Contract.md`
