# Kama Director Contract

## Director Identity
- **Director Name:** Kama
- **Title:** Engagement | Conversion | Audience Attraction Authority
- **Role ID:** kama
- **Phase:** Phase 1
- **Council:** Distribution & Evolution
- **Jurisdiction:** engagement optimization, conversion signals, audience attraction loops
- **Status:** Active
...
- **Runtime Location:** `registries/director_contracts/Kama-Contract.md`
