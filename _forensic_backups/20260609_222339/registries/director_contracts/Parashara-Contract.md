# Parashara Director Contract

## Director Identity
- **Director Name:** Parashara
- **Title:** Trend Analysis | Pattern Discovery Authority
- **Role ID:** parashara
- **Phase:** Phase 1
- **Council:** Research
- **Jurisdiction:** trend analysis, pattern discovery, longitudinal signal interpretation
- **Status:** Active
...
- **Runtime Location:** `registries/director_contracts/Parashara-Contract.md`
