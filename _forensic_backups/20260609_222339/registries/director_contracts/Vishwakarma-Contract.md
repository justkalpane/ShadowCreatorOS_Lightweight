# Vishwakarma Director Contract

## Director Identity
- **Director Name:** Vishwakarma
- **Title:** Architecture | Technical Production Authority
- **Role ID:** vishwakarma
- **Phase:** Phase 1
- **Council:** Production
- **Jurisdiction:** technical architecture, production infrastructure, build integrity
- **Status:** Active
...
- **Runtime Location:** `registries/director_contracts/Vishwakarma-Contract.md`
