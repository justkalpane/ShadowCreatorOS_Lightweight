...
route_families: [full_video_pipeline, context_engineering, script_generation]
...
route_family_resolved: [full_video_pipeline, context_engineering, script_generation]
