...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-102",
            "artifact_family": "heygen-avatar-render-orchestrator_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-102",
        "sub_skill_name": "HeyGen Avatar Render Orchestrator",
        "artifact_family": "heygen-avatar-render-orchestrator_packet",
        "created_at": now,
...
# component_id: SS-102-heygen-avatar-render-orchestrator
# component_layer: SKILL
# component_name: Ss 102 Heygen Avatar Render Orchestrator
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-102-heygen-avatar-render-orchestrator.py; component_id=SS-102-heygen-avatar-render-orchestrator
