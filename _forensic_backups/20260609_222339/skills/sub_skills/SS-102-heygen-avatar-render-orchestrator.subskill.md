...
route_families: [full_video_pipeline, avatar_video_context, approval_gate, repo_write_mode]
...
route_family_resolved: [full_video_pipeline, avatar_video_context, approval_gate, repo_write_mode]
