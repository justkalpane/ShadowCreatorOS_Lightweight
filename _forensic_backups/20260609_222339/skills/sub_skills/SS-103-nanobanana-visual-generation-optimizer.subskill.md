...
component_id: SS-103-nanobanana-visual-generation-optimizer.subskill
component_layer: SKILL
component_name: Ss 103 Nanobanana Visual Generation Optimizer.Subskill
route_families: [context_engineering, avatar_video_context, media_factory_handoff, visual_media_plan, media_factory_final_draft, approval_gate, repo_write_mode]
activation_triggers: route_family in [visual_context, quality_gate] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
route_family_resolved: [context_engineering, avatar_video_context, media_factory_handoff, visual_media_plan, media_factory_final_draft, approval_gate, repo_write_mode]
...
evidence_used_for_resolution: path/pre-contract keyword: approval/oauth; component_path=skills/sub_skills/SS-103-nanobanana-visual-generation-optimizer.subskill.md; component_id=SS-103-nanobanana-visual-generation-optimizer.subskill
