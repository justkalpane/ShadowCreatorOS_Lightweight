...
component_id: SS-104-sora-video-generation-orchestrator.subskill
component_layer: SKILL
component_name: Ss 104 Sora Video Generation Orchestrator.Subskill
route_families: [full_video_pipeline, context_engineering, avatar_video_context, media_factory_handoff, visual_media_plan, media_factory_final_draft, lineage_summary, approval_gate]
activation_triggers: route_family in [avatar_video_context, quality_gate, lineage_summary] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
route_family_resolved: [full_video_pipeline, context_engineering, avatar_video_context, media_factory_handoff, visual_media_plan, media_factory_final_draft, lineage_summary, approval_gate]
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/sub_skills/SS-104-sora-video-generation-orchestrator.subskill.md; component_id=SS-104-sora-video-generation-orchestrator.subskill
