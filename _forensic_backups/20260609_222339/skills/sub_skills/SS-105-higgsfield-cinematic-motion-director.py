...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-105",
            "artifact_family": "higgsfield-cinematic-motion-director_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-105",
        "sub_skill_name": "Higgsfield Cinematic Motion Director",
        "artifact_family": "higgsfield-cinematic-motion-director_packet",
        "created_at": now,
...
# component_id: SS-105-higgsfield-cinematic-motion-director
# component_layer: SKILL
# component_name: Ss 105 Higgsfield Cinematic Motion Director
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-105-higgsfield-cinematic-motion-director.py; component_id=SS-105-higgsfield-cinematic-motion-director
