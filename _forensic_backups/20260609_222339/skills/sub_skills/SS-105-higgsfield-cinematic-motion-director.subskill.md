...
component_id: SS-105-higgsfield-cinematic-motion-director.subskill
component_layer: SKILL
component_name: Ss 105 Higgsfield Cinematic Motion Director.Subskill
route_families: [avatar_video_context, media_factory_handoff, visual_media_plan, media_factory_final_draft, approval_gate, repo_write_mode]
activation_triggers: route_family in [quality_gate] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
route_family_resolved: [avatar_video_context, media_factory_handoff, visual_media_plan, media_factory_final_draft, approval_gate, repo_write_mode]
...
evidence_used_for_resolution: path/pre-contract keyword: approval/oauth; component_path=skills/sub_skills/SS-105-higgsfield-cinematic-motion-director.subskill.md; component_id=SS-105-higgsfield-cinematic-motion-director.subskill
