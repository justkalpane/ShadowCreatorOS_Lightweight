...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-106",
            "artifact_family": "kling-video-prompt-optimizer_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-106",
        "sub_skill_name": "Kling Video Prompt Optimizer",
        "artifact_family": "kling-video-prompt-optimizer_packet",
        "created_at": now,
...
# component_id: SS-106-kling-video-prompt-optimizer
# component_layer: SKILL
# component_name: Ss 106 Kling Video Prompt Optimizer
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-106-kling-video-prompt-optimizer.py; component_id=SS-106-kling-video-prompt-optimizer
