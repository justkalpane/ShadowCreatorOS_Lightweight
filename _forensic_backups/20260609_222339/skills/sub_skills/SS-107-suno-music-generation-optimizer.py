...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-107",
            "artifact_family": "suno-music-generation-optimizer_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-107",
        "sub_skill_name": "Suno Music Generation Optimizer",
        "artifact_family": "suno-music-generation-optimizer_packet",
        "created_at": now,
...
# component_id: SS-107-suno-music-generation-optimizer
# component_layer: SKILL
# component_name: Ss 107 Suno Music Generation Optimizer
# route_families: [provider_handoff, full_video_pipeline]
# activation_triggers: route_family in [music_sfx_context] or explicit registry selection; mark provider_handoff_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-107-suno-music-generation-optimizer.py; component_id=SS-107-suno-music-generation-optimizer
