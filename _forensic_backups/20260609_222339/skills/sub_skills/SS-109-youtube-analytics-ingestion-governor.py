...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-109",
            "artifact_family": "youtube-analytics-ingestion-governor_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-109",
        "sub_skill_name": "YouTube Analytics Ingestion Governor",
        "artifact_family": "youtube-analytics-ingestion-governor_packet",
        "created_at": now,
...
# component_id: SS-109-youtube-analytics-ingestion-governor
# component_layer: SKILL
# component_name: Ss 109 Youtube Analytics Ingestion Governor
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-109-youtube-analytics-ingestion-governor.py; component_id=SS-109-youtube-analytics-ingestion-governor
