...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-110",
            "artifact_family": "openrouter-llm-route-governor_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-110",
        "sub_skill_name": "OpenRouter LLM Route Governor",
        "artifact_family": "openrouter-llm-route-governor_packet",
        "created_at": now,
...
# component_id: SS-110-openrouter-llm-route-governor
# component_layer: SKILL
# component_name: Ss 110 Openrouter Llm Route Governor
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-110-openrouter-llm-route-governor.py; component_id=SS-110-openrouter-llm-route-governor
