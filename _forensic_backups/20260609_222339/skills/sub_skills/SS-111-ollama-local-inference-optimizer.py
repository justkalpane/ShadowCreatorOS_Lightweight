...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-111",
            "artifact_family": "ollama-local-inference-optimizer_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-111",
        "sub_skill_name": "Ollama Local Inference Optimizer",
        "artifact_family": "ollama-local-inference-optimizer_packet",
        "created_at": now,
...
# component_id: SS-111-ollama-local-inference-optimizer
# component_layer: SKILL
# component_name: Ss 111 Ollama Local Inference Optimizer
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-111-ollama-local-inference-optimizer.py; component_id=SS-111-ollama-local-inference-optimizer
