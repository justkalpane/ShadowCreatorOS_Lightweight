...
component_id: SS-111-ollama-local-inference-optimizer.subskill
component_layer: SKILL
component_name: Ss 111 Ollama Local Inference Optimizer.Subskill
...
evidence_used_for_resolution: path/pre-contract keyword: approval/oauth; component_path=skills/sub_skills/SS-111-ollama-local-inference-optimizer.subskill.md; component_id=SS-111-ollama-local-inference-optimizer.subskill
