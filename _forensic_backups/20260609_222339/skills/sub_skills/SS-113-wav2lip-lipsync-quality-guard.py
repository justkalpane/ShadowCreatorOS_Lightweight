...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-113",
            "artifact_family": "wav2lip-lipsync-quality-guard_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-113",
        "sub_skill_name": "Wav2Lip LipSync Quality Guard",
        "artifact_family": "wav2lip-lipsync-quality-guard_packet",
        "created_at": now,
...
# component_id: SS-113-wav2lip-lipsync-quality-guard
# component_layer: SKILL
# component_name: Ss 113 Wav2Lip Lipsync Quality Guard
# route_families: [provider_handoff, full_video_pipeline]
# activation_triggers: route_family in [quality_gate] or explicit registry selection; mark media_quality_gate_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-113-wav2lip-lipsync-quality-guard.py; component_id=SS-113-wav2lip-lipsync-quality-guard
