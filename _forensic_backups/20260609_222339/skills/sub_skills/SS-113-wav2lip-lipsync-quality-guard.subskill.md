...
component_id: SS-113-wav2lip-lipsync-quality-guard.subskill
component_layer: SKILL
component_name: Ss 113 Wav2Lip Lipsync Quality Guard.Subskill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [voice_context, music_sfx_context, avatar_video_context, quality_gate] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/sub_skills/SS-113-wav2lip-lipsync-quality-guard.subskill.md; component_id=SS-113-wav2lip-lipsync-quality-guard.subskill
