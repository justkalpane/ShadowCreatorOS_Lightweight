...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-114",
            "artifact_family": "yt-dlp-ingestion-compliance-guard_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-114",
        "sub_skill_name": "yt-dlp Ingestion Compliance Guard",
        "artifact_family": "yt-dlp-ingestion-compliance-guard_packet",
        "created_at": now,
...
# component_id: SS-114-yt-dlp-ingestion-compliance-guard
# component_layer: SKILL
# component_name: Ss 114 Yt Dlp Ingestion Compliance Guard
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-114-yt-dlp-ingestion-compliance-guard.py; component_id=SS-114-yt-dlp-ingestion-compliance-guard
