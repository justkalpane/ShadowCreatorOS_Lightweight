...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-115",
            "artifact_family": "gemini-multimodal-research-optimizer_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-115",
        "sub_skill_name": "Gemini Multimodal Research Optimizer",
        "artifact_family": "gemini-multimodal-research-optimizer_packet",
        "created_at": now,
...
# component_id: SS-115-gemini-multimodal-research-optimizer
# component_layer: SKILL
# component_name: Ss 115 Gemini Multimodal Research Optimizer
# route_families: [provider_handoff, full_video_pipeline]
# activation_triggers: route_family in [trend_research] or explicit registry selection; mark provider_handoff_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-115-gemini-multimodal-research-optimizer.py; component_id=SS-115-gemini-multimodal-research-optimizer
