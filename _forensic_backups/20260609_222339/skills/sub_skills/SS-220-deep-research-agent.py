...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-220",
        "sub_skill_name": "Deep Research Agent",
        "artifact_family": "deep-research-agent_packet",
        "created_at": now,
...
# component_id: SS-220-deep-research-agent
# component_layer: SKILL
# component_name: Ss 220 Deep Research Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-220-deep-research-agent.py; component_id=SS-220-deep-research-agent
