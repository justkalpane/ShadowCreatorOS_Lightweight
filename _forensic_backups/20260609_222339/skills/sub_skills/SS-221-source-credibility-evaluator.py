...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-221",
        "sub_skill_name": "Source Credibility Evaluator",
        "artifact_family": "source-credibility-evaluator_packet",
        "created_at": now,
...
# component_id: SS-221-source-credibility-evaluator
# component_layer: SKILL
# component_name: Ss 221 Source Credibility Evaluator
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-221-source-credibility-evaluator.py; component_id=SS-221-source-credibility-evaluator
