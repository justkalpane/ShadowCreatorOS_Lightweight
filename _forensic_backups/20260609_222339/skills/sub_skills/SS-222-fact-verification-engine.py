...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-222",
        "sub_skill_name": "Fact Verification Engine",
        "artifact_family": "fact-verification-engine_packet",
        "created_at": now,
...
# component_id: SS-222-fact-verification-engine
# component_layer: SKILL
# component_name: Ss 222 Fact Verification Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-222-fact-verification-engine.py; component_id=SS-222-fact-verification-engine
