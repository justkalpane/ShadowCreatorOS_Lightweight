...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-224",
        "sub_skill_name": "Contradiction Detector",
        "artifact_family": "contradiction-detector_packet",
        "created_at": now,
...
# component_id: SS-224-contradiction-detector
# component_layer: SKILL
# component_name: Ss 224 Contradiction Detector
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-224-contradiction-detector.py; component_id=SS-224-contradiction-detector
