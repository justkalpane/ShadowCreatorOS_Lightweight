...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-231",
            "artifact_family": "unique-value-proposition-builder_packet",
            "payload": {},
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-231",
        "sub_skill_name": "Unique Value Proposition Builder",
        "artifact_family": "unique-value-proposition-builder_packet",
        "created_at": now,
...
# component_id: SS-231-unique-value-proposition-builder
# component_layer: SKILL
# component_name: Ss 231 Unique Value Proposition Builder
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-231-unique-value-proposition-builder.py; component_id=SS-231-unique-value-proposition-builder
