...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-232",
        "sub_skill_name": "Series Strategy Planner",
        "artifact_family": "series-strategy-planner_packet",
        "created_at": now,
...
# component_id: SS-232-series-strategy-planner
# component_layer: SKILL
# component_name: Ss 232 Series Strategy Planner
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-232-series-strategy-planner.py; component_id=SS-232-series-strategy-planner
