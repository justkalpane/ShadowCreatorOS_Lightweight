...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-233",
        "sub_skill_name": "Content Calendar Generator",
        "artifact_family": "content-calendar-generator_packet",
        "created_at": now,
...
# component_id: SS-233-content-calendar-generator
# component_layer: SKILL
# component_name: Ss 233 Content Calendar Generator
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-233-content-calendar-generator.py; component_id=SS-233-content-calendar-generator
