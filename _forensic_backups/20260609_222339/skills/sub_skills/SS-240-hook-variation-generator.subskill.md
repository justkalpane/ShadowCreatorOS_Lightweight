...
component_id: SS-240-hook-variation-generator.subskill
component_layer: SKILL
component_name: Ss 240 Hook Variation Generator.Subskill
route_families: [script_refinement, script_generation, full_video_pipeline, lineage_summary, approval_gate]
activation_triggers: route_family in [topic_discovery, quality_gate, lineage_summary] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
route_family_resolved: [script_refinement, script_generation, full_video_pipeline, lineage_summary, approval_gate]
