...
# component_id: agent_recovery_004_agent
# component_layer: AGENT
# component_name: Agent Recovery 004 Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/agent_recovery_004/agent_recovery_004_agent.py; component_id=agent_recovery_004_agent
