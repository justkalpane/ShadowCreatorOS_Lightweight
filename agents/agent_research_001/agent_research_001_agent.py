...
# component_id: agent_research_001_agent
# component_layer: AGENT
# component_name: Agent Research 001 Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/agent_research_001/agent_research_001_agent.py; component_id=agent_research_001_agent
