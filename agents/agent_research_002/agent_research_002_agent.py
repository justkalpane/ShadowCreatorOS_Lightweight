...
class AgentResearch002Agent(ProductionAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(AgentResearch002Agent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: agent_research_002_agent
# component_layer: AGENT
# component_name: Agent Research 002 Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/agent_research_002/agent_research_002_agent.py; component_id=agent_research_002_agent
