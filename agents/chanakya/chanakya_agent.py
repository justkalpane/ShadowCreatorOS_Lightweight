...
class ChanakyaAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="chanakya",
            director_binding="Chanakya",
            artifact_family="chanakya-agent-packet",
...
if __name__ == "__main__":
    print_run(ChanakyaAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: chanakya_agent
# component_layer: AGENT
# component_name: Chanakya Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/chanakya/chanakya_agent.py; component_id=chanakya_agent
