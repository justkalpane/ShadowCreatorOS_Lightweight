...
class ChandraAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="chandra",
            director_binding="Chandra",
            artifact_family="chandra-agent-packet",
...
if __name__ == "__main__":
    print_run(ChandraAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: chandra_agent
# component_layer: AGENT
# component_name: Chandra Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/chandra/chandra_agent.py; component_id=chandra_agent
