...
class ChitraguptaAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="chitragupta",
            director_binding="Chitragupta",
            artifact_family="chitragupta-agent-packet",
...
if __name__ == "__main__":
    print_run(ChitraguptaAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: chitragupta_agent
# component_layer: AGENT
# component_name: Chitragupta Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/chitragupta/chitragupta_agent.py; component_id=chitragupta_agent
