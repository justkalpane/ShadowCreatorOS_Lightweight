...
# component_id: agent_class_matrix
# component_layer: AGENT
# component_name: Agent Class Matrix
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=agents/common/agent_class_matrix.py; component_id=agent_class_matrix
