...
# component_id: production_agent_base
# component_layer: AGENT
# component_name: Production Agent Base
# route_families: [quality_gate, full_video_pipeline]
# activation_triggers: route_family in [trend_research, editing_packaging, publishing] or explicit registry selection; mark research_synthesis_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: quality/governance; component_path=agents/common/production_agent_base.py; component_id=production_agent_base
