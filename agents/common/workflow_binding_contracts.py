...
WORKFLOW_BINDING_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    'cwf_210': {
        ...
        'phase_13e_13_film_lane_identity': {
            'status': 'ADDITIVE_WORKFLOW_BINDING_FILM_LANE_IDENTITY',
            ...
            'route_bindings_preserved_as_empty_child_lane': True,
    ...
    'wf_200': {
        ...
        'phase_13e_13_film_lane_identity': {
            ...
            'legacy_route_bindings_preserved': ['ROUTE_PHASE1_STANDARD', 'ROUTE_PHASE1_FAST'],
            'no_fake_pass_boundary': True,
        },
    },
    'wf_300': {
...
# component_id: workflow_binding_contracts
# component_layer: AGENT
# component_name: Workflow Binding Contracts
...
# evidence_used_for_resolution: path/pre-contract keyword: quality/governance; component_path=agents/common/workflow_binding_contracts.py; component_id=workflow_binding_contracts
