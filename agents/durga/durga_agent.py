...
class DurgaAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="durga",
            director_binding="Durga",
            artifact_family="durga-agent-packet",
...
if __name__ == "__main__":
    print_run(DurgaAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: durga_agent
# component_layer: AGENT
# component_name: Durga Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/durga/durga_agent.py; component_id=durga_agent
...
# cinema_craft_authority: 07 dramatic_conflict_and_stakes; 17 docudrama_ethics_and_source_separation
# mythology_fidelity_lock: protective force, confrontation, defense, and battle-tested moral pressure
# cinema_department_execution_role: Execute protective conflict, antagonist pressure, stakes escalation, and ethics guardrails.
# downstream_boundary: Controversy, outrage, rage-bait, or viral conflict are not film-core conflict authority.
