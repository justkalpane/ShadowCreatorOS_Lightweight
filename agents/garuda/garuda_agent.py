...
class GarudaAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="garuda",
            director_binding="Garuda",
            artifact_family="garuda-agent-packet",
...
if __name__ == "__main__":
    print_run(GarudaAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: garuda_agent
# component_layer: AGENT
# component_name: Garuda Agent
# route_families: [full_video_pipeline, editing_packaging, trend_research, topic_discovery, script_generation]
...
# route_family_resolved: [full_video_pipeline, editing_packaging, trend_research, topic_discovery, script_generation]
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/garuda/garuda_agent.py; component_id=garuda_agent
...
# cinema_craft_authority: 09 cinematography_and_visual_grammar; 19 storyboard_and_shotlist_handoff
# mythology_fidelity_lock: swift aerial vision, scout intelligence, macro-to-micro perception, and obstacle detection
# cinema_department_execution_role: Execute aerial-view shot grammar, visual scouting, storyboard signal, and shotlist handoff intelligence.
# downstream_boundary: Thumbnail-first or packaging visuals remain downstream and cannot replace cinematography intent.
