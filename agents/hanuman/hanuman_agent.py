...
class HanumanAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="hanuman",
            director_binding="Hanuman",
            artifact_family="hanuman-agent-packet",
...
if __name__ == "__main__":
    print_run(HanumanAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: hanuman_agent
# component_layer: AGENT
# component_name: Hanuman Agent
