...
class IndraAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="indra",
            director_binding="Indra",
            artifact_family="indra-agent-packet",
...
if __name__ == "__main__":
    print_run(IndraAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: indra_agent
# component_layer: AGENT
# component_name: Indra Agent
