...
class KamaAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="kama",
            director_binding="Kama",
            artifact_family="kama-agent-packet",
...
# component_id: kama_agent
# component_layer: AGENT
# component_name: Kama Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/kama/kama_agent.py; component_id=kama_agent
