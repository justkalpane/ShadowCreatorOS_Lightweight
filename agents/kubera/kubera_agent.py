...
class KuberaAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="kubera",
            director_binding="Kubera",
            artifact_family="kubera-agent-packet",
...
if __name__ == "__main__":
    print_run(KuberaAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: kubera_agent
# component_layer: AGENT
# component_name: Kubera Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/kubera/kubera_agent.py; component_id=kubera_agent
