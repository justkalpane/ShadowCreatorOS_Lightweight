...
class RavanaAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="ravana",
            director_binding="Ravana",
            artifact_family="ravana-agent-packet",
...
if __name__ == "__main__":
    print_run(RavanaAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: ravana_agent
# component_layer: AGENT
# component_name: Ravana Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/ravana/ravana_agent.py; component_id=ravana_agent
