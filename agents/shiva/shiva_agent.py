...
class ShivaAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="shiva",
            director_binding="Shiva",
            artifact_family="shiva-agent-packet",
...
if __name__ == "__main__":
    print_run(ShivaAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: shiva_agent
# component_layer: AGENT
# component_name: Shiva Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/shiva/shiva_agent.py; component_id=shiva_agent
...
# cinema_craft_authority: 13 editing_rhythm_and_pacing; 22 post_production_and_finishing
# mythology_fidelity_lock: destruction, transformation, reset, austerity, and creative rebuilding
# cinema_department_execution_role: Execute revision cuts, structural reset, edit-rhythm transformation, and finishing discipline.
# downstream_boundary: Script quality veto or content approval cannot replace film revision and transformation authority.
