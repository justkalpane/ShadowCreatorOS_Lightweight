...
class TumburuAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="tumburu",
            director_binding="Tumburu",
            artifact_family="tumburu-agent-packet",
...
if __name__ == "__main__":
    print_run(TumburuAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: tumburu_agent
# component_layer: AGENT
# component_name: Tumburu Agent
# route_families: [voice_context, trend_research, topic_discovery, script_generation]
...
# route_family_resolved: [voice_context, trend_research, topic_discovery, script_generation]
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/tumburu/tumburu_agent.py; component_id=tumburu_agent
