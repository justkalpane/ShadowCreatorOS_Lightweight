...
class VarunaAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="varuna",
            director_binding="Varuna",
            artifact_family="varuna-agent-packet",
...
if __name__ == "__main__":
    print_run(VarunaAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: varuna_agent
# component_layer: AGENT
# component_name: Varuna Agent
# route_families: [voice_context, media_factory_handoff, visual_media_plan, media_factory_final_draft, avatar_video_context, context_engineering]
...
# route_family_resolved: [voice_context, media_factory_handoff, visual_media_plan, media_factory_final_draft, avatar_video_context, context_engineering]
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/varuna/varuna_agent.py; component_id=varuna_agent
...
# cinema_craft_authority: 02 research_and_world_truth; 10 lighting_and_mood; 14 sound_design_and_atmosphere
# mythology_fidelity_lock: depth, atmosphere, water, hidden truth, emotional weather, and ambience
# cinema_department_execution_role: Execute hidden-truth ambience, emotional weather, light mood, and sonic atmosphere mapping.
# downstream_boundary: Generic ambience or stock sound design cannot replace film atmosphere authority.
