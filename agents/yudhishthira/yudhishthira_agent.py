...
class YudhishthiraAgent(ProductionAgentBase):
    def __init__(
        self,
        ...
        super().__init__(
            agent_slug="yudhishthira",
            director_binding="Yudhishthira",
            artifact_family="yudhishthira-agent-packet",
...
if __name__ == "__main__":
    print_run(YudhishthiraAgent())


# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: yudhishthira_agent
# component_layer: AGENT
# component_name: Yudhishthira Agent
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=agents/yudhishthira/yudhishthira_agent.py; component_id=yudhishthira_agent
