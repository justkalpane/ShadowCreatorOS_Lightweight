...
`ROUTE_SCOPE_FILE_AUDIT` is drift. The audit must prove at least 68 route-scope
files and include individual agent, subagent, skill, and subskill file reads.
Summarizing names such as "Krishna, Aruna..." is not enough.
