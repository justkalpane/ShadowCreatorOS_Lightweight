...
Repo-first means actual route-file consumption, not summarized familiarity. If
route scope cannot be completed because of time, context, token, or tool
pressure, stop with `BLOCKED_BEFORE_OUTPUT`; never produce synthetic ledgers or
claim unread components were used.
