...
# component_name: Directors Complete Registry
...
# evidence_used_for_resolution: path/pre-contract keyword: approval/oauth; component_path=directors/DIRECTORS_COMPLETE_REGISTRY.py; component_id=str
