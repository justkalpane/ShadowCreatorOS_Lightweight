...
component_id: DIRECTOR:_HANUMAN
component_layer: DIRECTOR
component_name: Hanuman
route_families: [quality_gate, full_video_pipeline]
activation_triggers: route_family in [script_generation, trend_research, topic_discovery, music_sfx_context] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
