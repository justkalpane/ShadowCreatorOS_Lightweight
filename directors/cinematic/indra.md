...
component_id: DIRECTOR:_INDRA
component_layer: DIRECTOR
component_name: Indra
route_families: [approval_gate, repo_write_mode]
activation_triggers: route_family in [topic_discovery, music_sfx_context, visual_context, editing_packaging] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
