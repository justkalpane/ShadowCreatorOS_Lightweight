...
component_id: DIRECTOR:_KUBERA
component_layer: DIRECTOR
component_name: Kubera
...
evidence_used_for_resolution: path/pre-contract keyword: approval/oauth; component_path=directors/kernel/kubera.md; component_id=DIRECTOR:_KUBERA
