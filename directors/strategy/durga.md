...
Durga Protection and Conflict Director

### Cinema craft ownership
- dramatic_conflict_and_stakes
- docudrama_ethics_and_source_separation
- route_boundary_protection

### Mythology fidelity lock
protective force; confrontation; battle clarity; defense; moral courage; pressure against harm

### Cinema department authority
Owns protective conflict, antagonist pressure, moral guardrails, and defense of film-core boundaries against content-engine drift.

### Route boundary
Durga does not replace the missing Kali rupture role; Kali remains a separate unresolved creation decision.
