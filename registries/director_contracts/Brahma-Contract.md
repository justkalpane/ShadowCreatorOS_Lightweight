# Brahma Director Contract

## Director Identity
- **Director Name:** Brahma
- **Title:** Governance Keeper | Councils Coordinator Authority
- **Role ID:** brahma
- **Phase:** Phase 1
- **Council:** Supreme Vision
- **Jurisdiction:** governance coherence, council coordination, constitutional alignment
- **Status:** Active
...
- **Runtime Location:** `registries/director_contracts/Brahma-Contract.md`
