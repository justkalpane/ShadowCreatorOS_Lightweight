# Hanuman Director Contract

## Director Identity
- **Director Name:** Hanuman
- **Title:** Speed | Fast-Track Execution Authority
- **Role ID:** hanuman
- **Phase:** Phase 1
- **Council:** Cinematic
- **Jurisdiction:** fast-track execution, throughput optimization, deadline-critical delivery
- **Status:** Active
...
- **Runtime Location:** `registries/director_contracts/Hanuman-Contract.md`
