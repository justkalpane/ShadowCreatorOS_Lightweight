# Maya Director Contract

## Director Identity
- **Director Name:** Maya
- **Title:** Visual Production | Creative Visualization Authority
- **Role ID:** maya
- **Phase:** Phase 1
- **Council:** Production
- **Jurisdiction:** visual production, creative visualization, aesthetic packaging
- **Status:** Active
...
- **Runtime Location:** `registries/director_contracts/Maya-Contract.md`
