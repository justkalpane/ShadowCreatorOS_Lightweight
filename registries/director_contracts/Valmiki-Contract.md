# Valmiki Director Contract

## Director Identity
- **Director Name:** Valmiki
- **Title:** Research Synthesis | Knowledge Structuring Authority
- **Role ID:** valmiki
- **Phase:** Phase 1
- **Council:** Research
- **Jurisdiction:** research synthesis, knowledge structuring, narrative evidence consolidation
- **Status:** Active
...
- **Runtime Location:** `registries/director_contracts/Valmiki-Contract.md`
