# Character Web And Opposing Force Contract
...
## Scope
Future governance for the film character layer. This skeleton defines the intended contract boundary without enforcement.
...
This contract should govern future film character decisions, keeping cinema-first behavior separate from content/platform behavior.

## Required Future Schema Links
- `schemas/film/character/film_character_web.schema.json`
- `schemas/film/output_packet/film_screenplay_output_packet.schema.json`

## Required Future Validator Links
- `validators/film/character/validate_character_web_opposing_force.py`
