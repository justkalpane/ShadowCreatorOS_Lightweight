# Film Downstream Handoff Contract
...
## Scope
Future governance for the film downstream_handoff layer. This skeleton defines the intended contract boundary without enforcement.
...
This contract should govern future film downstream_handoff decisions, keeping cinema-first behavior separate from content/platform behavior.

## Required Future Schema Links
- `schemas/film/downstream_handoff/film_downstream_handoff_packet.schema.json`
- `schemas/film/output_packet/film_screenplay_output_packet.schema.json`

## Required Future Validator Links
- `validators/film/downstream_handoff/validate_film_downstream_handoff_packet.py`

## Required Future Fixture Links
- `tests/fixtures/downstream_handoff/film_packet_to_visual_media_plan.json`
- `tests/fixtures/downstream_handoff/film_packet_to_voice_context.json`
