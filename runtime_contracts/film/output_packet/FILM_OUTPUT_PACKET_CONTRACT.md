...
## Scope
Future governance for the film output_packet layer. This skeleton defines the intended contract boundary without enforcement.
...
This contract should govern future film output_packet decisions, keeping cinema-first behavior separate from content/platform behavior.

## Required Future Schema Links
- `schemas/film/output_packet/film_screenplay_output_packet.schema.json`
- `schemas/film/output_packet/film_route_state_capsule.schema.json`
...
- `validators/film/output_packet/validate_screenplay_format.py`
