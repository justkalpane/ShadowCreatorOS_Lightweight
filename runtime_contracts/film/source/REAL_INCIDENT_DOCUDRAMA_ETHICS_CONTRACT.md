# Real Incident Docudrama Ethics Contract
...
## Scope
Future governance for the film source layer. This skeleton defines the intended contract boundary without enforcement.
...
This contract should govern future film source decisions, keeping cinema-first behavior separate from content/platform behavior.

## Required Future Schema Links
- `schemas/film/source/film_real_incident_ethics.schema.json`
- `schemas/film/source/film_source_ledger.schema.json`
- `schemas/film/source/film_fact_vs_anecdote_map.schema.json`

## Required Future Validator Links
- `validators/film/source/validate_real_incident_docudrama_ethics.py`
- `validators/film/source/validate_film_source_ledger.py`

## Required Future Fixture Links
- `tests/fixtures/no_fake_pass/real_world_film_without_source_ledger_should_fail.json`
