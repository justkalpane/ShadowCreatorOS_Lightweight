# Film Validation Scorecard Contract
...
## Scope
Future governance for the film validation layer. This skeleton defines the intended contract boundary without enforcement.
...
This contract should govern future film validation decisions, keeping cinema-first behavior separate from content/platform behavior.

## Required Future Schema Links
- `schemas/film/validation/film_validation_scorecard.schema.json`
- `schemas/film/validation/no_fake_film_pass.schema.json`
...
- `tests/fixtures/no_fake_pass/film_output_without_filmcraft_scorecard_should_fail.json`
