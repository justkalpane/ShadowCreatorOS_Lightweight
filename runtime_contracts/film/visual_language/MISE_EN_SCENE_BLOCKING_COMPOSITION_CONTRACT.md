# Mise En Scene Blocking Composition Contract
...
## Scope
Future governance for the film visual_language layer. This skeleton defines the intended contract boundary without enforcement.
...
This contract should govern future film visual_language decisions, keeping cinema-first behavior separate from content/platform behavior.

## Required Future Schema Links
- `schemas/film/visual_language/film_mise_en_scene_blocking_composition.schema.json`
- `schemas/film/visual_language/film_camera_language.schema.json`

## Required Future Validator Links
- `validators/film/visual_language/validate_mise_en_scene.py`
- `validators/film/visual_language/validate_blocking_composition.py`

## Required Future Fixture Links
- `tests/fixtures/film_packet_validation/missing_camera_composition_should_fail.json`
