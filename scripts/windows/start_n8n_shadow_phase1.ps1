...
$canonicalN8nProfile = "C:\ShadowEmpire\n8n_user_restore_01"
$canonicalN8nDb = Join-Path $canonicalN8nProfile ".n8n\database.sqlite"
$canonicalN8nStorage = Join-Path $canonicalN8nProfile ".n8n\binaryData"

if (-not (Test-Path $canonicalN8nDb)) {
  throw "Canonical n8n database not found: $canonicalN8nDb. Refusing to start from any fallback/old profile."
}

New-Item -ItemType Directory -Force $canonicalN8nStorage | Out-Null

if (Test-Path Env:N8N_BINARY_DATA_STORAGE_PATH) {
  Remove-Item Env:N8N_BINARY_DATA_STORAGE_PATH
}

$env:N8N_USER_FOLDER = $canonicalN8nProfile
$env:N8N_DEFAULT_BINARY_DATA_MODE = "filesystem"
$env:N8N_STORAGE_PATH = $canonicalN8nStorage
...
Write-Output "  N8N_DATABASE    = $canonicalN8nDb"
Write-Output "  N8N_STORAGE_PATH = $env:N8N_STORAGE_PATH"
...
Write-Output "  NODE_FUNCTION_ALLOW_EXTERNAL = $env:NODE_FUNCTION_ALLOW_EXTERNAL"
