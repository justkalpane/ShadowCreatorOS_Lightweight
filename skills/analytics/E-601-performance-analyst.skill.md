# SKL-PH1-PERFORMANCE-ANALYST

## 1. Skill Identity
- **Skill ID:** E-601
- **Skill Name:** Performance Analyst
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for E-601 (Performance Analyst). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** performance-analyst_executor
...
- **Downstream Handoff:** performance-analyst_packet -> downstream workflow chain
...
3. Execute core transformation logic for E-601
...
```json
{
  "instance_id": "E-601-[timestamp]",
  "artifact_family": "performance-analyst_packet",
...
**Write Targets:**
- dossier.analytics_vein.performance-analyst (append_to_array)
...
**Writes:**
- dossier.analytics_vein.performance-analyst (append_only)
...
**Acceptance Tests:**
- TEST-PH1-E601-001: valid input produces CREATED packet
- TEST-PH1-E601-002: invalid input escalates to WF-900
- TEST-PH1-E601-003: dossier patch is additive only
...
component_id: E-601-performance-analyst.skill
component_layer: SKILL
component_name: E 601 Performance Analyst.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/analytics/E-601-performance-analyst.skill.md; component_id=E-601-performance-analyst.skill
