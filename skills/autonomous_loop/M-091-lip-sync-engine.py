...
# component_id: M-091-lip-sync-engine
# component_layer: SKILL
# component_name: M 091 Lip Sync Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/autonomous_loop/M-091-lip-sync-engine.py; component_id=M-091-lip-sync-engine
