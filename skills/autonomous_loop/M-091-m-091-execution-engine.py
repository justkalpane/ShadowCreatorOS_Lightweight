...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "skill_id": "M-091",
        "skill_name": "M-091 Execution Engine",
...
# component_id: M-091-m-091-execution-engine
# component_layer: SKILL
# component_name: M 091 M 091 Execution Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/autonomous_loop/M-091-m-091-execution-engine.py; component_id=M-091-m-091-execution-engine
