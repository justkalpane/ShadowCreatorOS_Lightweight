...
# component_id: M-092-avatar-rendering-engine
# component_layer: SKILL
# component_name: M 092 Avatar Rendering Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/autonomous_loop/M-092-avatar-rendering-engine.py; component_id=M-092-avatar-rendering-engine
