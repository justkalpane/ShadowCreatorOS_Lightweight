...
# component_id: M-093-visual-effects-engine
# component_layer: SKILL
# component_name: M 093 Visual Effects Engine
# route_families: [video_context, avatar_video_context, full_video_pipeline]
# activation_triggers: route_family in [visual_context] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/autonomous_loop/M-093-visual-effects-engine.py; component_id=M-093-visual-effects-engine
