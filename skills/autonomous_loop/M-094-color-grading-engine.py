...
# component_id: M-094-color-grading-engine
# component_layer: SKILL
# component_name: M 094 Color Grading Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/autonomous_loop/M-094-color-grading-engine.py; component_id=M-094-color-grading-engine
