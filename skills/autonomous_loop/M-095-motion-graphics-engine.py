...
# component_id: M-095-motion-graphics-engine
# component_layer: SKILL
# component_name: M 095 Motion Graphics Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/autonomous_loop/M-095-motion-graphics-engine.py; component_id=M-095-motion-graphics-engine
