...
# component_id: M-096-transition-designer
# component_layer: SKILL
# component_name: M 096 Transition Designer
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/autonomous_loop/M-096-transition-designer.py; component_id=M-096-transition-designer
