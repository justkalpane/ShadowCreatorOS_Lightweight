...
# component_id: M-097-pacing-optimizer
# component_layer: SKILL
# component_name: M 097 Pacing Optimizer
...
# evidence_used_for_resolution: path/pre-contract keyword: refinement/optimization; component_path=skills/autonomous_loop/M-097-pacing-optimizer.py; component_id=M-097-pacing-optimizer
