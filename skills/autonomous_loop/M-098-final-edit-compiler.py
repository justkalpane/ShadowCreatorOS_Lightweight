...
# component_id: M-098-final-edit-compiler
# component_layer: SKILL
# component_name: M 098 Final Edit Compiler
# route_families: [editing_packaging, full_video_pipeline, publishing]
# activation_triggers: route_family in [editing_packaging] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: editing/packaging/platform; component_path=skills/autonomous_loop/M-098-final-edit-compiler.py; component_id=M-098-final-edit-compiler
