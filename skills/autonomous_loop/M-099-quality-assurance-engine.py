...
# component_id: M-099-quality-assurance-engine
# component_layer: SKILL
# component_name: M 099 Quality Assurance Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: quality/governance; component_path=skills/autonomous_loop/M-099-quality-assurance-engine.py; component_id=M-099-quality-assurance-engine
