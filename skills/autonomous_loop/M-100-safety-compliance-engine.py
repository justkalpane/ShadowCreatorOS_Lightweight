...
# component_id: M-100-safety-compliance-engine
# component_layer: SKILL
# component_name: M 100 Safety Compliance Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: quality/governance; component_path=skills/autonomous_loop/M-100-safety-compliance-engine.py; component_id=M-100-safety-compliance-engine
