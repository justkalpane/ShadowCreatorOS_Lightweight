...
# component_id: M-101-decision-board
# component_layer: SKILL
# component_name: M 101 Decision Board
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-101-decision-board.py; component_id=M-101-decision-board
