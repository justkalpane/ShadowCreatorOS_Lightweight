...
# component_id: M-102-escalation-engine
# component_layer: SKILL
# component_name: M 102 Escalation Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-102-escalation-engine.py; component_id=M-102-escalation-engine
