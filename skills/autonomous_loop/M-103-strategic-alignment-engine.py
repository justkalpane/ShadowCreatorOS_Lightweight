...
# component_id: M-103-strategic-alignment-engine
# component_layer: SKILL
# component_name: M 103 Strategic Alignment Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-103-strategic-alignment-engine.py; component_id=M-103-strategic-alignment-engine
