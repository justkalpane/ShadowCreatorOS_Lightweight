...
# component_id: M-105-publishing-engine
# component_layer: SKILL
# component_name: M 105 Publishing Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: editing/packaging/platform; component_path=skills/autonomous_loop/M-105-publishing-engine.py; component_id=M-105-publishing-engine
