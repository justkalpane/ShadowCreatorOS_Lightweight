...
- Strategic Authority Director: Agastya
- Upstream Dependencies: M-104
- Downstream Consumers: M-106
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic publishing engine outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-105 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.publishing_engine with append-only write intent.
...
5. Execute deterministic transformation graph for publishing_engine.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m105_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m105_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m105_packet
- JSON Schema Reference: schemas/packets/m105_packet.schema.json
- Dossier Write Target: dossier.script_vein.publishing_engine
...
## 12. Validation/Done
- TEST-M-105-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-105-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-105_Publishing_Engine
component_layer: SKILL
component_name: M 105 Publishing Engine.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, publishing, quality_gate, lineage_summary] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/autonomous_loop/M-105-publishing-engine.skill.md; component_id=M-105_Publishing_Engine
