...
# component_id: M-106-upload-verification
# component_layer: SKILL
# component_name: M 106 Upload Verification
...
# evidence_used_for_resolution: path/pre-contract keyword: editing/packaging/platform; component_path=skills/autonomous_loop/M-106-upload-verification.py; component_id=M-106-upload-verification
