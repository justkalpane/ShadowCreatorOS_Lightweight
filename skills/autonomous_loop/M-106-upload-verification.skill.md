...
- Upstream Dependencies: M-105
- Downstream Consumers: M-107
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic upload verification outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-106 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.upload_verification with append-only write intent.
...
5. Execute deterministic transformation graph for upload_verification.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m106_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m106_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m106_packet
- JSON Schema Reference: schemas/packets/m106_packet.schema.json
- Dossier Write Target: dossier.script_vein.upload_verification
...
## 12. Validation/Done
- TEST-M-106-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-106-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-106_Upload_Verification
component_layer: SKILL
component_name: M 106 Upload Verification.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/autonomous_loop/M-106-upload-verification.skill.md; component_id=M-106_Upload_Verification
