...
# component_id: M-107-algorithm-kickstart-engine
# component_layer: SKILL
# component_name: M 107 Algorithm Kickstart Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-107-algorithm-kickstart-engine.py; component_id=M-107-algorithm-kickstart-engine
