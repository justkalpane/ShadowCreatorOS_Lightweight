...
# component_id: M-109-comment-analyzer
# component_layer: SKILL
# component_name: M 109 Comment Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-109-comment-analyzer.py; component_id=M-109-comment-analyzer
