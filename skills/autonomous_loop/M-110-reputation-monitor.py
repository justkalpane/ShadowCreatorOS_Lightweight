...
# component_id: M-110-reputation-monitor
# component_layer: SKILL
# component_name: M 110 Reputation Monitor
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-110-reputation-monitor.py; component_id=M-110-reputation-monitor
