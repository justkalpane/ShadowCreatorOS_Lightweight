...
# component_id: M-111-feedback-learning-engine
# component_layer: SKILL
# component_name: M 111 Feedback Learning Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-111-feedback-learning-engine.py; component_id=M-111-feedback-learning-engine
