...
# component_id: M-113-empire-growth-engine
# component_layer: SKILL
# component_name: M 113 Empire Growth Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-113-empire-growth-engine.py; component_id=M-113-empire-growth-engine
