...
# component_id: M-114-resource-expansion-engine
# component_layer: SKILL
# component_name: M 114 Resource Expansion Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-114-resource-expansion-engine.py; component_id=M-114-resource-expansion-engine
