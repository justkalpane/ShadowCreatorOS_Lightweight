...
# component_id: M-115-automation-expansion-engine
# component_layer: SKILL
# component_name: M 115 Automation Expansion Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-115-automation-expansion-engine.py; component_id=M-115-automation-expansion-engine
