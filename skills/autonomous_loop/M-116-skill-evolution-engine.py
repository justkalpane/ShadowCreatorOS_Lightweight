...
# component_id: M-116-skill-evolution-engine
# component_layer: SKILL
# component_name: M 116 Skill Evolution Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-116-skill-evolution-engine.py; component_id=M-116-skill-evolution-engine
