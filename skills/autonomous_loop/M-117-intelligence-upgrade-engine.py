...
# component_id: M-117-intelligence-upgrade-engine
# component_layer: SKILL
# component_name: M 117 Intelligence Upgrade Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-117-intelligence-upgrade-engine.py; component_id=M-117-intelligence-upgrade-engine
