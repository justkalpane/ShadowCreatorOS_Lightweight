...
# component_id: M-118-empire-security-engine
# component_layer: SKILL
# component_name: M 118 Empire Security Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-118-empire-security-engine.py; component_id=M-118-empire-security-engine
