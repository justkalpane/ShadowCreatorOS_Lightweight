...
# component_id: M-120-supreme-orchestrator
# component_layer: SKILL
# component_name: M 120 Supreme Orchestrator
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/autonomous_loop/M-120-supreme-orchestrator.py; component_id=M-120-supreme-orchestrator
