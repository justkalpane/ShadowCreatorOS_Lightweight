...
## 2. Purpose
Runtime-ready canonical skill artifact for P-301 (execution_context_engineer). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** execution-context-engineer_executor
...
- **Producer:** WF
- **Direct Consumers:** CWF-320-Platform-Packager
- **Upstream Dependencies:** workflow_registry, skill_loader_registry, dossier packet context
- **Downstream Handoff:** execution-context-engineer_packet -> downstream workflow chain
...
3. Execute core transformation logic for P-301
...
**Write Targets:**
- dossier.context_engineering_vein.execution-context-engineer (append_to_array)
...
**Writes:**
- dossier.context_engineering_vein.execution-context-engineer (append_only)
...
**Acceptance Tests:**
- TEST-PH1-P301-001: valid input produces CREATED packet
- TEST-PH1-P301-002: invalid input escalates to WF-900
- TEST-PH1-P301-003: dossier patch is additive only
...
component_id: P-301-execution-context-engineer.skill
component_layer: SKILL
component_name: P 301 Execution Context Engineer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: context engineering; component_path=skills/context_engineering/P-301-execution-context-engineer.skill.md; component_id=P-301-execution-context-engineer.skill
