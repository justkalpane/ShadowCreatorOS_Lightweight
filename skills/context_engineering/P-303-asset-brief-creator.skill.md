...
## 2. Purpose
Runtime-ready canonical skill artifact for P-303 (asset_brief_creator). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** asset-brief-creator_executor
- **DNA Archetype:** Durga
...
- **Producer:** WF
- **Direct Consumers:** CWF-340-Lineage-Validator, WF-400-Media-Production
- **Upstream Dependencies:** workflow_registry, skill_loader_registry, dossier packet context
- **Downstream Handoff:** asset-brief-creator_packet -> downstream workflow chain
...
3. Execute core transformation logic for P-303
...
**Write Targets:**
- dossier.context_engineering_vein.asset-brief-creator (append_to_array)
- se_packet_index (single index row)

## 8. Governance
- **Director Binding:** Durga (owner), Krishna (strategic authority)
...
**Writes:**
- dossier.context_engineering_vein.asset-brief-creator (append_only)
...
**Acceptance Tests:**
- TEST-PH1-P303-001: valid input produces CREATED packet
- TEST-PH1-P303-002: invalid input escalates to WF-900
- TEST-PH1-P303-003: dossier patch is additive only
...
component_id: P-303-asset-brief-creator.skill
component_layer: SKILL
component_name: P 303 Asset Brief Creator.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: context engineering; component_path=skills/context_engineering/P-303-asset-brief-creator.skill.md; component_id=P-303-asset-brief-creator.skill
