...
## 2. Purpose
Runtime-ready canonical skill artifact for P-304 (lineage_chain_validator). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** lineage-chain-validator_executor
...
- **Producer:** WF
- **Direct Consumers:** CWF-340-Lineage-Validator (internal), WF-400-Media-Production (gated by output)
- **Upstream Dependencies:** workflow_registry, skill_loader_registry, dossier packet context
- **Downstream Handoff:** lineage-chain-validator_packet -> downstream workflow chain
...
3. Execute core transformation logic for P-304
...
**Write Targets:**
- dossier.context_engineering_vein.lineage-chain-validator (append_to_array)
...
**Writes:**
- dossier.context_engineering_vein.lineage-chain-validator (append_only)
...
**Acceptance Tests:**
- TEST-PH1-P304-001: valid input produces CREATED packet
- TEST-PH1-P304-002: invalid input escalates to WF-900
- TEST-PH1-P304-003: dossier patch is additive only
...
component_id: P-304-lineage-chain-validator.skill
component_layer: SKILL
component_name: P 304 Lineage Chain Validator.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: context engineering; component_path=skills/context_engineering/P-304-lineage-chain-validator.skill.md; component_id=P-304-lineage-chain-validator.skill
