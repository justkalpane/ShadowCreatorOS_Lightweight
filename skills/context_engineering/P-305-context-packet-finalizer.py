...
# component_id: P-305-context-packet-finalizer
# component_layer: SKILL
# component_name: P 305 Context Packet Finalizer
# route_families: [context_engineering, script_generation]
# activation_triggers: route_family in [script_generation, editing_packaging, publishing, quality_gate] or explicit registry selection; mark editing_packaging_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: context engineering; component_path=skills/context_engineering/P-305-context-packet-finalizer.py; component_id=P-305-context-packet-finalizer
