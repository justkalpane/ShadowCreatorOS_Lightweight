...
## 2. Purpose
Runtime-ready canonical skill artifact for P-305 (context_packet_finalizer). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** context-packet-finalizer_executor
...
- **Producer:** WF
- **Direct Consumers:** WF-400-Media-Production
- **Upstream Dependencies:** workflow_registry, skill_loader_registry, dossier packet context
- **Downstream Handoff:** context-packet-finalizer_packet -> downstream workflow chain
...
3. Execute core transformation logic for P-305
...
**Write Targets:**
- dossier.context_engineering_vein.context-packet-finalizer (append_to_array)
...
**Writes:**
- dossier.context_engineering_vein.context-packet-finalizer (append_only)
...
**Acceptance Tests:**
- TEST-PH1-P305-001: valid input produces CREATED packet
- TEST-PH1-P305-002: invalid input escalates to WF-900
- TEST-PH1-P305-003: dossier patch is additive only
...
component_id: P-305-context-packet-finalizer.skill
component_layer: SKILL
component_name: P 305 Context Packet Finalizer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: context engineering; component_path=skills/context_engineering/P-305-context-packet-finalizer.skill.md; component_id=P-305-context-packet-finalizer.skill
