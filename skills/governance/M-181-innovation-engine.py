...
# component_id: M-181-innovation-engine
# component_layer: SKILL
# component_name: M 181 Innovation Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: quality/governance; component_path=skills/governance/M-181-innovation-engine.py; component_id=M-181-innovation-engine
