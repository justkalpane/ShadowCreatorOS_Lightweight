...
- Upstream Dependencies: M-181
- Downstream Consumers: M-201
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic collaboration engine outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-182 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.collaboration_engine with append-only write intent.
...
5. Execute deterministic transformation graph for collaboration_engine.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m182_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m182_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m182_packet
- JSON Schema Reference: schemas/packets/m182_packet.schema.json
- Dossier Write Target: dossier.script_vein.collaboration_engine
...
## 12. Validation/Done
- TEST-M-182-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-182-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-182_Collaboration_Engine
component_layer: SKILL
component_name: M 182 Collaboration Engine.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/governance/M-182-collaboration-engine.skill.md; component_id=M-182_Collaboration_Engine
