...
# component_id: M-001-intent-cortex
# component_layer: SKILL
# component_name: M 001 Intent Cortex
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/intelligence/M-001-intent-cortex.py; component_id=M-001-intent-cortex
