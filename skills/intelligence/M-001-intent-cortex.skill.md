...
- Downstream Consumers: M-002
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic intent cortex outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-001 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.intent_cortex with append-only write intent.
...
5. Execute deterministic transformation graph for intent_cortex.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m001_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m001_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m001_packet
- JSON Schema Reference: schemas/packets/m001_packet.schema.json
- Dossier Write Target: dossier.research_vein.intent_cortex
...
## 12. Validation/Done
- TEST-M-001-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-001-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-001_Intent_Cortex
component_layer: SKILL
component_name: M 001 Intent Cortex.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/intelligence/M-001-intent-cortex.skill.md; component_id=M-001_Intent_Cortex
