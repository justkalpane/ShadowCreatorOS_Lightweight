...
# component_id: M-002-context-analyzer
# component_layer: SKILL
# component_name: M 002 Context Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/intelligence/M-002-context-analyzer.py; component_id=M-002-context-analyzer
