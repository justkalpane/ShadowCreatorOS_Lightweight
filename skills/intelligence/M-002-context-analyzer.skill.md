...
- Upstream Dependencies: M-001
- Downstream Consumers: M-003
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic context analyzer outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-002 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.context_analyzer with append-only write intent.
...
5. Execute deterministic transformation graph for context_analyzer.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m002_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m002_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m002_packet
- JSON Schema Reference: schemas/packets/m002_packet.schema.json
- Dossier Write Target: dossier.research_vein.context_analyzer
...
## 12. Validation/Done
- TEST-M-002-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-002-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-002_Context_Analyzer
component_layer: SKILL
component_name: M 002 Context Analyzer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/intelligence/M-002-context-analyzer.skill.md; component_id=M-002_Context_Analyzer
