...
component_id: SKL-PH3C-M-231-VOICEOVER_DIRECTION_SCRIPT
component_layer: SKILL
component_name: M 231 Voiceover Direction Script.Skill
route_families: [voice_context, lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, voice_context, music_sfx_context, avatar_video_context] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_audio/M-231-voiceover-direction-script.skill.md; component_id=SKL-PH3C-M-231-VOICEOVER_DIRECTION_SCRIPT
