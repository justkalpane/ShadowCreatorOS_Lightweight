...
## 7. Outputs
- Output Packet Family: m232_packet
- JSON Schema Reference: schemas/packets/m232_packet.schema.json
...
component_id: SKL-PH3C-M-232-SOUND_DESIGN_BRIEF
component_layer: SKILL
component_name: M 232 Sound Design Brief.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_audio/M-232-sound-design-brief.skill.md; component_id=SKL-PH3C-M-232-SOUND_DESIGN_BRIEF
