...
## 7. Outputs
- Output Packet Family: m237_packet
- JSON Schema Reference: schemas/packets/m237_packet.schema.json
...
component_id: SKL-PH3C-M-237-AUDIO_LEVELS_NORMALIZATION
component_layer: SKILL
component_name: M 237 Audio Levels Normalization.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_audio/M-237-audio-levels-normalization.skill.md; component_id=SKL-PH3C-M-237-AUDIO_LEVELS_NORMALIZATION
