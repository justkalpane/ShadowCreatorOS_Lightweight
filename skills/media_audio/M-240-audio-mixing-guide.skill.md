...
## 7. Outputs
- Output Packet Family: m240_packet
- JSON Schema Reference: schemas/packets/m240_packet.schema.json
...
component_id: SKL-PH3C-M-240-AUDIO_MIXING_GUIDE
component_layer: SKILL
component_name: M 240 Audio Mixing Guide.Skill
route_families: [voice_context, lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, music_sfx_context, avatar_video_context, quality_gate] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_audio/M-240-audio-mixing-guide.skill.md; component_id=SKL-PH3C-M-240-AUDIO_MIXING_GUIDE
