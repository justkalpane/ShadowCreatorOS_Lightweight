...
component_id: SKL-PH3C-M-242-PODCAST_INTRO_OUTRO_DESIGNER
component_layer: SKILL
component_name: M 242 Podcast Intro Outro Designer.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, music_sfx_context, avatar_video_context, editing_packaging] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_audio/M-242-podcast-intro-outro-designer.skill.md; component_id=SKL-PH3C-M-242-PODCAST_INTRO_OUTRO_DESIGNER
