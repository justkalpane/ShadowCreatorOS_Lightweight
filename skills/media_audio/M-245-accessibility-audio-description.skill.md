...
## 7. Outputs
- Output Packet Family: m245_packet
- JSON Schema Reference: schemas/packets/m245_packet.schema.json
...
component_id: SKL-PH3C-M-245-ACCESSIBILITY_AUDIO_DESCRIPTION
component_layer: SKILL
component_name: M 245 Accessibility Audio Description.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, music_sfx_context, avatar_video_context, publishing] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_audio/M-245-accessibility-audio-description.skill.md; component_id=SKL-PH3C-M-245-ACCESSIBILITY_AUDIO_DESCRIPTION
