...
## 7. Outputs
- Output Packet Family: m204_packet
- JSON Schema Reference: schemas/packets/m204_packet.schema.json
...
component_id: SKL-PH3A-M-204-LAYOUT_COMPOSITION_STRATEGIST
component_layer: SKILL
component_name: M 204 Layout Composition Strategist.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_graphics/M-204-layout-composition-strategist.skill.md; component_id=SKL-PH3A-M-204-LAYOUT_COMPOSITION_STRATEGIST
