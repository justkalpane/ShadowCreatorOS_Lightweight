...
component_id: SKL-PH3A-M-205-ICON_ILLUSTRATION_MAPPER
component_layer: SKILL
component_name: M 205 Icon Illustration Mapper.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_graphics/M-205-icon-illustration-mapper.skill.md; component_id=SKL-PH3A-M-205-ICON_ILLUSTRATION_MAPPER
