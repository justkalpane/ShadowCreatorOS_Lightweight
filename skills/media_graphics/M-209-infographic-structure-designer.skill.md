...
## 7. Outputs
- Output Packet Family: m209_packet
- JSON Schema Reference: schemas/packets/m209_packet.schema.json
...
component_id: SKL-PH3A-M-209-INFOGRAPHIC_STRUCTURE_DESIGNER
component_layer: SKILL
component_name: M 209 Infographic Structure Designer.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, visual_context, lineage_summary] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_graphics/M-209-infographic-structure-designer.skill.md; component_id=SKL-PH3A-M-209-INFOGRAPHIC_STRUCTURE_DESIGNER
