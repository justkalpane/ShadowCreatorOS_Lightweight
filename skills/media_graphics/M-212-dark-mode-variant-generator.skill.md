...
## 7. Outputs
- Output Packet Family: m212_packet
- JSON Schema Reference: schemas/packets/m212_packet.schema.json
...
component_id: SKL-PH3A-M-212-DARK_MODE_VARIANT_GENERATOR
component_layer: SKILL
component_name: M 212 Dark Mode Variant Generator.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_graphics/M-212-dark-mode-variant-generator.skill.md; component_id=SKL-PH3A-M-212-DARK_MODE_VARIANT_GENERATOR
