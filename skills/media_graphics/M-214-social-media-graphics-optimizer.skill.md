...
## 7. Outputs
- Output Packet Family: m214_packet
- JSON Schema Reference: schemas/packets/m214_packet.schema.json
...
component_id: SKL-PH3A-M-214-SOCIAL_MEDIA_GRAPHICS_OPTIMIZER
component_layer: SKILL
component_name: M 214 Social Media Graphics Optimizer.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [visual_context, lineage_summary] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_graphics/M-214-social-media-graphics-optimizer.skill.md; component_id=SKL-PH3A-M-214-SOCIAL_MEDIA_GRAPHICS_OPTIMIZER
