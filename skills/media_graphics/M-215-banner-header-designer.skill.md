...
## 7. Outputs
- Output Packet Family: m215_packet
- JSON Schema Reference: schemas/packets/m215_packet.schema.json
...
component_id: SKL-PH3A-M-215-BANNER_HEADER_DESIGNER
component_layer: SKILL
component_name: M 215 Banner Header Designer.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [visual_context, avatar_video_context, lineage_summary] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_graphics/M-215-banner-header-designer.skill.md; component_id=SKL-PH3A-M-215-BANNER_HEADER_DESIGNER
