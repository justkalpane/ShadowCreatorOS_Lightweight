# SKL-PH1-VISUAL-ASSET-PLANNER

## 1. Skill Identity
- **Skill ID:** A-402
- **Skill Name:** Visual Asset Planner
- **Version:** 1.0.0
- **Phase Scope:** PHASE_1_TOPIC_TO_SCRIPT
- **Classification:** github_source_of_truth
- **Owner Workflow:** SE-N8N-WF
- **Consumer Workflows:** WF-400, CWF-410, CWF-420, CWF-430, CWF-440
- **Vein/Route/Stage:** media_production_vein / topic_to_script / Stage_E_Media

## 2. Purpose
Runtime-ready canonical skill artifact for A-402 (Visual Asset Planner). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** visual-asset-planner_executor
- **DNA Archetype:** Vishwakarma
...
- **Producer:** WF
- **Direct Consumers:** WF-400, CWF-410, CWF-420, CWF-430, CWF-440
- **Upstream Dependencies:** workflow_registry, skill_loader_registry, dossier packet context
- **Downstream Handoff:** visual-asset-planner_packet -> downstream workflow chain
...
3. Execute core transformation logic for A-402
...
**Write Targets:**
- dossier.media_production_vein.visual-asset-planner (append_to_array)
- se_packet_index (single index row)

## 8. Governance
- **Director Binding:** Vishwakarma (owner), Krishna (strategic authority)
...
**Writes:**
- dossier.media_production_vein.visual-asset-planner (append_only)
...
**Acceptance Tests:**
- TEST-PH1-A402-001: valid input produces CREATED packet
- TEST-PH1-A402-002: invalid input escalates to WF-900
- TEST-PH1-A402-003: dossier patch is additive only
...
component_id: A-402-visual-asset-planner.skill
component_layer: SKILL
component_name: A 402 Visual Asset Planner.Skill
route_families: [media_factory_handoff, visual_media_plan, media_factory_final_draft, lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, topic_discovery, visual_context, quality_gate] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
route_family_resolved: [media_factory_handoff, visual_media_plan, media_factory_final_draft, lineage_summary, approval_gate]
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_production/A-402-visual-asset-planner.skill.md; component_id=A-402-visual-asset-planner.skill
...
route_state_requirements:
  ...
  bridge_job_packet_required_for_local_handoff: true
