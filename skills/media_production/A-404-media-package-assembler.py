...
# component_id: A-404-media-package-assembler
# component_layer: SKILL
# component_name: A 404 Media Package Assembler
# route_families: [context_engineering, script_generation]
# activation_triggers: route_family in [script_generation, music_sfx_context, visual_context, editing_packaging] or explicit registry selection; mark editing_packaging_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: context engineering; component_path=skills/media_production/A-404-media-package-assembler.py; component_id=A-404-media-package-assembler
