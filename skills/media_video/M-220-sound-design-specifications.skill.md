...
## 7. Outputs
- Output Packet Family: m220_packet
- JSON Schema Reference: schemas/packets/m220_packet.schema.json
...
component_id: SKL-PH3B-M-220-SOUND_DESIGN_SPECIFICATIONS
component_layer: SKILL
component_name: M 220 Sound Design Specifications.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_video/M-220-sound-design-specifications.skill.md; component_id=SKL-PH3B-M-220-SOUND_DESIGN_SPECIFICATIONS
