...
## 7. Outputs
- Output Packet Family: m222_packet
- JSON Schema Reference: schemas/packets/m222_packet.schema.json
...
component_id: SKL-PH3B-M-222-VIDEO_TRANSITIONS_OPTIMIZER
component_layer: SKILL
component_name: M 222 Video Transitions Optimizer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_video/M-222-video-transitions-optimizer.skill.md; component_id=SKL-PH3B-M-222-VIDEO_TRANSITIONS_OPTIMIZER
