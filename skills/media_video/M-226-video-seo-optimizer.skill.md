...
component_id: SKL-PH3B-M-226-VIDEO_SEO_OPTIMIZER
component_layer: SKILL
component_name: M 226 Video Seo Optimizer.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, topic_discovery, avatar_video_context, lineage_summary] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_video/M-226-video-seo-optimizer.skill.md; component_id=SKL-PH3B-M-226-VIDEO_SEO_OPTIMIZER
