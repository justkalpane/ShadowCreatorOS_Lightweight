...
component_id: SKL-PH3B-M-227-CAPTIONS_SUBTITLE_GENERATOR
component_layer: SKILL
component_name: M 227 Captions Subtitle Generator.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, voice_context, avatar_video_context, lineage_summary] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_video/M-227-captions-subtitle-generator.skill.md; component_id=SKL-PH3B-M-227-CAPTIONS_SUBTITLE_GENERATOR
