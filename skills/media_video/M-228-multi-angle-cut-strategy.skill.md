...
## 7. Outputs
- Output Packet Family: m228_packet
- JSON Schema Reference: schemas/packets/m228_packet.schema.json
...
component_id: SKL-PH3B-M-228-MULTI_ANGLE_CUT_STRATEGY
component_layer: SKILL
component_name: M 228 Multi Angle Cut Strategy.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/media_video/M-228-multi-angle-cut-strategy.skill.md; component_id=SKL-PH3B-M-228-MULTI_ANGLE_CUT_STRATEGY
