...
# component_id: M-151-empire-expansion-layer
# component_layer: SKILL
# component_name: M 151 Empire Expansion Layer
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-151-empire-expansion-layer.py; component_id=M-151-empire-expansion-layer
