...
# component_id: M-152-channel-discovery-engine
# component_layer: SKILL
# component_name: M 152 Channel Discovery Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-152-channel-discovery-engine.py; component_id=M-152-channel-discovery-engine
