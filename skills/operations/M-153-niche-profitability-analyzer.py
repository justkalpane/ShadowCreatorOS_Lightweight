...
# component_id: M-153-niche-profitability-analyzer
# component_layer: SKILL
# component_name: M 153 Niche Profitability Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-153-niche-profitability-analyzer.py; component_id=M-153-niche-profitability-analyzer
