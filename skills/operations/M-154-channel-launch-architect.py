...
# component_id: M-154-channel-launch-architect
# component_layer: SKILL
# component_name: M 154 Channel Launch Architect
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-154-channel-launch-architect.py; component_id=M-154-channel-launch-architect
