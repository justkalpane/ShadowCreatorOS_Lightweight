...
# component_id: M-155-brand-identity-engine
# component_layer: SKILL
# component_name: M 155 Brand Identity Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: visual/image/design; component_path=skills/operations/M-155-brand-identity-engine.py; component_id=M-155-brand-identity-engine
