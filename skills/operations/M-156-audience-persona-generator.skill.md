# M-156 Audience Persona Generator
...
- Upstream Dependencies: M-155
- Downstream Consumers: M-157
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic audience persona generator outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-156 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.audience_persona_generator with append-only write intent.
...
5. Execute deterministic transformation graph for audience_persona_generator.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m156_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m156_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m156_packet
- JSON Schema Reference: schemas/packets/m156_packet.schema.json
- Dossier Write Target: dossier.script_vein.audience_persona_generator
...
## 12. Validation/Done
- TEST-M-156-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-156-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-156_Audience_Persona_Generator
component_layer: SKILL
component_name: M 156 Audience Persona Generator.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/operations/M-156-audience-persona-generator.skill.md; component_id=M-156_Audience_Persona_Generator
