...
# component_id: M-157-content-strategy-replicator
# component_layer: SKILL
# component_name: M 157 Content Strategy Replicator
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-157-content-strategy-replicator.py; component_id=M-157-content-strategy-replicator
