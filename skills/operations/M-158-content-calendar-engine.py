...
# component_id: M-158-content-calendar-engine
# component_layer: SKILL
# component_name: M 158 Content Calendar Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-158-content-calendar-engine.py; component_id=M-158-content-calendar-engine
