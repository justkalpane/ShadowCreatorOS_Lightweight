...
# component_id: M-159-production-capacity-planner
# component_layer: SKILL
# component_name: M 159 Production Capacity Planner
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-159-production-capacity-planner.py; component_id=M-159-production-capacity-planner
