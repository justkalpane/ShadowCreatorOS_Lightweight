...
# component_id: M-160-creator-clone-system
# component_layer: SKILL
# component_name: M 160 Creator Clone System
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-160-creator-clone-system.py; component_id=M-160-creator-clone-system
