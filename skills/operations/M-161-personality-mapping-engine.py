...
# component_id: M-161-personality-mapping-engine
# component_layer: SKILL
# component_name: M 161 Personality Mapping Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-161-personality-mapping-engine.py; component_id=M-161-personality-mapping-engine
