...
component_id: M-162_Voice_Identity_Cloner
component_layer: SKILL
component_name: M 162 Voice Identity Cloner.Skill
route_families: [voice_context, lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, voice_context, quality_gate, lineage_summary] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/operations/M-162-voice-identity-cloner.skill.md; component_id=M-162_Voice_Identity_Cloner
