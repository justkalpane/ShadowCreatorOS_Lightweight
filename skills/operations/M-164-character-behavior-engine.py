...
# component_id: M-164-character-behavior-engine
# component_layer: SKILL
# component_name: M 164 Character Behavior Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-164-character-behavior-engine.py; component_id=M-164-character-behavior-engine
