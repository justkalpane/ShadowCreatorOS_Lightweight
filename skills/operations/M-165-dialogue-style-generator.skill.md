# M-165 Dialogue Style Generator
...
- Upstream Dependencies: M-164
- Downstream Consumers: M-166
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic dialogue style generator outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-165 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.dialogue_style_generator with append-only write intent.
...
5. Execute deterministic transformation graph for dialogue_style_generator.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m165_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m165_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m165_packet
- JSON Schema Reference: schemas/packets/m165_packet.schema.json
- Dossier Write Target: dossier.script_vein.dialogue_style_generator
...
## 12. Validation/Done
- TEST-M-165-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-165-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-165_Dialogue_Style_Generator
component_layer: SKILL
component_name: M 165 Dialogue Style Generator.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/operations/M-165-dialogue-style-generator.skill.md; component_id=M-165_Dialogue_Style_Generator
