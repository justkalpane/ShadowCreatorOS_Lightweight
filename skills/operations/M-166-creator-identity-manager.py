...
# component_id: M-166-creator-identity-manager
# component_layer: SKILL
# component_name: M 166 Creator Identity Manager
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-166-creator-identity-manager.py; component_id=M-166-creator-identity-manager
