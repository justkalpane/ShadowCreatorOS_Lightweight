...
# component_id: M-167-reputation-control-engine
# component_layer: SKILL
# component_name: M 167 Reputation Control Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-167-reputation-control-engine.py; component_id=M-167-reputation-control-engine
