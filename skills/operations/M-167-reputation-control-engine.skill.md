# M-167 Reputation Control Engine
...
- Upstream Dependencies: M-166
- Downstream Consumers: M-168
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic reputation control engine outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-167 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.reputation_control_engine with append-only write intent.
...
5. Execute deterministic transformation graph for reputation_control_engine.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m167_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m167_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m167_packet
- JSON Schema Reference: schemas/packets/m167_packet.schema.json
- Dossier Write Target: dossier.script_vein.reputation_control_engine
...
## 12. Validation/Done
- TEST-M-167-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-167-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-167_Reputation_Control_Engine
component_layer: SKILL
component_name: M 167 Reputation Control Engine.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/operations/M-167-reputation-control-engine.skill.md; component_id=M-167_Reputation_Control_Engine
