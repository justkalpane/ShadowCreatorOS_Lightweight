# M-168 Content Factory Controller
...
- Strategic Authority Director: Tumburu
- Upstream Dependencies: M-167
- Downstream Consumers: M-169
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic content factory controller outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-168 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.content_factory_controller with append-only write intent.
...
5. Execute deterministic transformation graph for content_factory_controller.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m168_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m168_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m168_packet
- JSON Schema Reference: schemas/packets/m168_packet.schema.json
- Dossier Write Target: dossier.script_vein.content_factory_controller
...
## 12. Validation/Done
- TEST-M-168-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-168-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-168_Content_Factory_Controller
component_layer: SKILL
component_name: M 168 Content Factory Controller.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/operations/M-168-content-factory-controller.skill.md; component_id=M-168_Content_Factory_Controller
