...
# component_id: M-169-topic-generation-engine
# component_layer: SKILL
# component_name: M 169 Topic Generation Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-169-topic-generation-engine.py; component_id=M-169-topic-generation-engine
