...
# component_id: M-171-knowledge-graph-builder
# component_layer: SKILL
# component_name: M 171 Knowledge Graph Builder
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-171-knowledge-graph-builder.py; component_id=M-171-knowledge-graph-builder
