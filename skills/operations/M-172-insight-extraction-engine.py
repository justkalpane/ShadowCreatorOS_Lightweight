...
# component_id: M-172-insight-extraction-engine
# component_layer: SKILL
# component_name: M 172 Insight Extraction Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-172-insight-extraction-engine.py; component_id=M-172-insight-extraction-engine
