...
# component_id: M-173-script-automation-engine
# component_layer: SKILL
# component_name: M 173 Script Automation Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/operations/M-173-script-automation-engine.py; component_id=M-173-script-automation-engine
