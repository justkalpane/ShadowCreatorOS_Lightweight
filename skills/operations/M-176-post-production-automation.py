...
# component_id: M-176-post-production-automation
# component_layer: SKILL
# component_name: M 176 Post Production Automation
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-176-post-production-automation.py; component_id=M-176-post-production-automation
