...
# component_id: M-177-performance-tracking-engine
# component_layer: SKILL
# component_name: M 177 Performance Tracking Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-177-performance-tracking-engine.py; component_id=M-177-performance-tracking-engine
