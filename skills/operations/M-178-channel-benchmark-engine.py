...
# component_id: M-178-channel-benchmark-engine
# component_layer: SKILL
# component_name: M 178 Channel Benchmark Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-178-channel-benchmark-engine.py; component_id=M-178-channel-benchmark-engine
