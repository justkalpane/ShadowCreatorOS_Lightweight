...
# component_id: M-179-competitive-intelligence-engine
# component_layer: SKILL
# component_name: M 179 Competitive Intelligence Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-179-competitive-intelligence-engine.py; component_id=M-179-competitive-intelligence-engine
