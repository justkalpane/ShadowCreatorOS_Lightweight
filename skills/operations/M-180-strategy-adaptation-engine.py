...
# component_id: M-180-strategy-adaptation-engine
# component_layer: SKILL
# component_name: M 180 Strategy Adaptation Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/operations/M-180-strategy-adaptation-engine.py; component_id=M-180-strategy-adaptation-engine
