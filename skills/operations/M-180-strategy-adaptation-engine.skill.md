# M-180 Strategy Adaptation Engine
...
- Upstream Dependencies: M-179
- Downstream Consumers: M-181
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic strategy adaptation engine outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-180 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.strategy_adaptation_engine with append-only write intent.
...
5. Execute deterministic transformation graph for strategy_adaptation_engine.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m180_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m180_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m180_packet
- JSON Schema Reference: schemas/packets/m180_packet.schema.json
- Dossier Write Target: dossier.script_vein.strategy_adaptation_engine
...
## 12. Validation/Done
- TEST-M-180-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-180-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-180_Strategy_Adaptation_Engine
component_layer: SKILL
component_name: M 180 Strategy Adaptation Engine.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/operations/M-180-strategy-adaptation-engine.skill.md; component_id=M-180_Strategy_Adaptation_Engine
