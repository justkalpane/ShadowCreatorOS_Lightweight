...
component_id: D-502-seo-optimization-specialist.skill
component_layer: SKILL
component_name: D 502 Seo Optimization Specialist.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, topic_discovery, publishing, quality_gate] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/publishing/D-502-seo-optimization-specialist.skill.md; component_id=D-502-seo-optimization-specialist.skill
