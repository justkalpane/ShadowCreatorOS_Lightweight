...
# component_id: M-009-knowledge-source-collector
# component_layer: SKILL
# component_name: M 009 Knowledge Source Collector
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/research_intelligence/M-009-knowledge-source-collector.py; component_id=M-009-knowledge-source-collector
