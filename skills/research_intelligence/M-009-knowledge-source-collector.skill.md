# M-009 Knowledge Source Collector
...
- Upstream Dependencies: M-008
- Downstream Consumers: M-010
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic knowledge source collector outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-009 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.knowledge_source_collector with append-only write intent.
...
5. Execute deterministic transformation graph for knowledge_source_collector.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m009_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m009_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m009_packet
- JSON Schema Reference: schemas/packets/m009_packet.schema.json
- Dossier Write Target: dossier.research_vein.knowledge_source_collector
...
## 12. Validation/Done
- TEST-M-009-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-009-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-009_Knowledge_Source_Collector
component_layer: SKILL
component_name: M 009 Knowledge Source Collector.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/research_intelligence/M-009-knowledge-source-collector.skill.md; component_id=M-009_Knowledge_Source_Collector
