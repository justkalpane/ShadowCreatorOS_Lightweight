...
# component_id: M-010-source-credibility-validator
# component_layer: SKILL
# component_name: M 010 Source Credibility Validator
...
# evidence_used_for_resolution: path/pre-contract keyword: quality/governance; component_path=skills/research_intelligence/M-010-source-credibility-validator.py; component_id=M-010-source-credibility-validator
