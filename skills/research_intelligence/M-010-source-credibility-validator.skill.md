# M-010 Source Credibility Validator
...
- Upstream Dependencies: M-009
- Downstream Consumers: M-011
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic source credibility validator outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-010 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.source_credibility_validator with append-only write intent.
...
5. Execute deterministic transformation graph for source_credibility_validator.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m010_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m010_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m010_packet
- JSON Schema Reference: schemas/packets/m010_packet.schema.json
- Dossier Write Target: dossier.research_vein.source_credibility_validator
...
## 12. Validation/Done
- TEST-M-010-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-010-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-010_Source_Credibility_Validator
component_layer: SKILL
component_name: M 010 Source Credibility Validator.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/research_intelligence/M-010-source-credibility-validator.skill.md; component_id=M-010_Source_Credibility_Validator
