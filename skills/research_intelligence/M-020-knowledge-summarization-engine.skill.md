# M-020 Knowledge Summarization Engine
...
- Owner Director: Maya
- Strategic Authority Director: Indra
- Upstream Dependencies: M-019
- Downstream Consumers: M-021
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic knowledge summarization engine outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-020 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.knowledge_summarization_engine with append-only write intent.
...
5. Execute deterministic transformation graph for knowledge_summarization_engine.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m020_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m020_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m020_packet
- JSON Schema Reference: schemas/packets/m020_packet.schema.json
- Dossier Write Target: dossier.research_vein.knowledge_summarization_engine
...
## 12. Validation/Done
- TEST-M-020-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-020-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-020_Knowledge_Summarization_Engine
component_layer: SKILL
component_name: M 020 Knowledge Summarization Engine.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/research_intelligence/M-020-knowledge-summarization-engine.skill.md; component_id=M-020_Knowledge_Summarization_Engine
