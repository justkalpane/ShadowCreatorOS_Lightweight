...
# component_id: M-021-fact-cross-verification-unit
# component_layer: SKILL
# component_name: M 021 Fact Cross Verification Unit
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/research_intelligence/M-021-fact-cross-verification-unit.py; component_id=M-021-fact-cross-verification-unit
