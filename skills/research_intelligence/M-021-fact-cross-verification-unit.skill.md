...
component_id: M-021-fact-cross-verification-unit.skill
component_layer: SKILL
component_name: M 021 Fact Cross Verification Unit.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [trend_research, lineage_summary] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/research_intelligence/M-021-fact-cross-verification-unit.skill.md; component_id=M-021-fact-cross-verification-unit.skill
