...
# component_id: M-022-knowledge-graph-builder
# component_layer: SKILL
# component_name: M 022 Knowledge Graph Builder
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/research_intelligence/M-022-knowledge-graph-builder.py; component_id=M-022-knowledge-graph-builder
