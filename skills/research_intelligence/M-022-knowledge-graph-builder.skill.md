...
component_id: M-022-knowledge-graph-builder.skill
component_layer: SKILL
component_name: M 022 Knowledge Graph Builder.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/research_intelligence/M-022-knowledge-graph-builder.skill.md; component_id=M-022-knowledge-graph-builder.skill
