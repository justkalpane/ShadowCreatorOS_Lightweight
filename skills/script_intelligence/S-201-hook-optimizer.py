...
# component_id: S-201-hook-optimizer
# component_layer: SKILL
# component_name: S 201 Hook Optimizer
...
# evidence_used_for_resolution: path/pre-contract keyword: refinement/optimization; component_path=skills/script_intelligence/S-201-hook-optimizer.py; component_id=S-201-hook-optimizer
