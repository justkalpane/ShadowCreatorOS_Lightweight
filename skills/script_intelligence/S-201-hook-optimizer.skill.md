# SKL-PH1-HOOK-OPTIMIZER

## 1. Skill Identity
- **Skill ID:** S-201
- **Skill Name:** Hook Optimizer
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for S-201 (Hook Optimizer). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** hook-optimizer_executor
...
- **Downstream Handoff:** hook-optimizer_packet -> downstream workflow chain
...
```json
{
  ...
  "artifact_family": "hook-optimizer_packet",
...
**Write Targets:**
- dossier.narrative_vein.hook-optimizer (append_to_array)
...
**Writes:**
- dossier.narrative_vein.hook-optimizer (append_only)
