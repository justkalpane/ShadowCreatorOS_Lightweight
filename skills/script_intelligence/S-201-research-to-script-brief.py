...
# component_id: S-201-research-to-script-brief
# component_layer: SKILL
# component_name: S 201 Research To Script Brief
# route_families: [script_generation]
# activation_triggers: route_family in [script_generation, trend_research] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
