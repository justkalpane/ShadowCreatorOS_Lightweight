...
component_id: S-201-research-to-script-brief.skill
component_layer: SKILL
component_name: S 201 Research To Script Brief.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, trend_research, topic_discovery, quality_gate] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/script_intelligence/S-201-research-to-script-brief.skill.md; component_id=S-201-research-to-script-brief.skill
