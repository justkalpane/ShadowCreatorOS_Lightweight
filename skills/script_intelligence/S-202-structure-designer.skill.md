# SKL-PH1-STRUCTURE-DESIGNER

## 1. Skill Identity
- **Skill ID:** S-202
- **Skill Name:** Structure Designer
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for S-202 (Structure Designer). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** structure-designer_executor
...
- **Downstream Handoff:** structure-designer_packet -> downstream workflow chain
...
3. Execute core transformation logic for S-202
...
```json
{
  "instance_id": "S-202-[timestamp]",
  "artifact_family": "structure-designer_packet",
...
**Write Targets:**
- dossier.narrative_vein.structure-designer (append_to_array)
...
**Writes:**
- dossier.narrative_vein.structure-designer (append_only)
...
**Acceptance Tests:**
- TEST-PH1-S202-001: valid input produces CREATED packet
- TEST-PH1-S202-002: invalid input escalates to WF-900
- TEST-PH1-S202-003: dossier patch is additive only
...
component_id: S-202-structure-designer.skill
component_layer: SKILL
component_name: S 202 Structure Designer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/script_intelligence/S-202-structure-designer.skill.md; component_id=S-202-structure-designer.skill
