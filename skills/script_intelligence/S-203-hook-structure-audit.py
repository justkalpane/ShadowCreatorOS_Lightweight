...
# component_id: S-203-hook-structure-audit
# component_layer: SKILL
# component_name: S 203 Hook Structure Audit
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence/S-203-hook-structure-audit.py; component_id=S-203-hook-structure-audit
