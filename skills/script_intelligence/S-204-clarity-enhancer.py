...
# component_id: S-204-clarity-enhancer
# component_layer: SKILL
# component_name: S 204 Clarity Enhancer
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence/S-204-clarity-enhancer.py; component_id=S-204-clarity-enhancer
