...
# component_id: S-204-narrative-logic-audit
# component_layer: SKILL
# component_name: S 204 Narrative Logic Audit
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence/S-204-narrative-logic-audit.py; component_id=S-204-narrative-logic-audit
