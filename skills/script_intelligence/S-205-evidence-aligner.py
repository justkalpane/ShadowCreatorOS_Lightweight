...
# component_id: S-205-evidence-aligner
# component_layer: SKILL
# component_name: S 205 Evidence Aligner
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence/S-205-evidence-aligner.py; component_id=S-205-evidence-aligner
