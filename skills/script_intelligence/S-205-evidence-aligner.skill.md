# SKL-PH1-EVIDENCE-ALIGNER

## 1. Skill Identity
- **Skill ID:** S-205
- **Skill Name:** Evidence Aligner
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for S-205 (Evidence Aligner). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** evidence-aligner_executor
...
- **Downstream Handoff:** evidence-aligner_packet -> downstream workflow chain
...
```json
{
  ...
  "artifact_family": "evidence-aligner_packet",
...
**Write Targets:**
- dossier.narrative_vein.evidence-aligner (append_to_array)
...
**Writes:**
- dossier.narrative_vein.evidence-aligner (append_only)
...
component_id: S-205-evidence-aligner.skill
component_layer: SKILL
component_name: S 205 Evidence Aligner.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/script_intelligence/S-205-evidence-aligner.skill.md; component_id=S-205-evidence-aligner.skill
