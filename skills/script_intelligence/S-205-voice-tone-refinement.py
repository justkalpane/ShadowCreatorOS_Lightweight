...
# component_id: S-205-voice-tone-refinement
# component_layer: SKILL
# component_name: S 205 Voice Tone Refinement
# route_families: [voice_context, context_engineering]
# activation_triggers: route_family in [script_generation, voice_context] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: voice/audio; component_path=skills/script_intelligence/S-205-voice-tone-refinement.py; component_id=S-205-voice-tone-refinement
