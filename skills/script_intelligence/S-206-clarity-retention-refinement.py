...
# component_id: S-206-clarity-retention-refinement
# component_layer: SKILL
# component_name: S 206 Clarity Retention Refinement
...
# evidence_used_for_resolution: path/pre-contract keyword: refinement/optimization; component_path=skills/script_intelligence/S-206-clarity-retention-refinement.py; component_id=S-206-clarity-retention-refinement
