...
# component_id: S-207-narrative-flow-optimizer
# component_layer: SKILL
# component_name: S 207 Narrative Flow Optimizer
...
# evidence_used_for_resolution: path/pre-contract keyword: refinement/optimization; component_path=skills/script_intelligence/S-207-narrative-flow-optimizer.py; component_id=S-207-narrative-flow-optimizer
