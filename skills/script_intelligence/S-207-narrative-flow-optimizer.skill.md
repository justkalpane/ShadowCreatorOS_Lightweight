# SKL-PH1-NARRATIVE-FLOW-OPTIMIZER

## 1. Skill Identity
- **Skill ID:** S-207
- **Skill Name:** Narrative Flow Optimizer
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for S-207 (Narrative Flow Optimizer). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** narrative-flow-optimizer_executor
...
- **Downstream Handoff:** narrative-flow-optimizer_packet -> downstream workflow chain
...
3. Execute core transformation logic for S-207
...
```json
{
  "instance_id": "S-207-[timestamp]",
  "artifact_family": "narrative-flow-optimizer_packet",
  ...
  "payload": {
    "skill_id": "S-207",
    "skill_name": "Narrative Flow Optimizer",
    "result": {}
  }
}
```
...
**Write Targets:**
- dossier.narrative_vein.narrative-flow-optimizer (append_to_array)
...
**Writes:**
- dossier.narrative_vein.narrative-flow-optimizer (append_only)
...
**Acceptance Tests:**
- TEST-PH1-S207-001: valid input produces CREATED packet
- TEST-PH1-S207-002: invalid input escalates to WF-900
- TEST-PH1-S207-003: dossier patch is additive only
...
component_id: S-207-narrative-flow-optimizer.skill
component_layer: SKILL
component_name: S 207 Narrative Flow Optimizer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/script_intelligence/S-207-narrative-flow-optimizer.skill.md; component_id=S-207-narrative-flow-optimizer.skill
