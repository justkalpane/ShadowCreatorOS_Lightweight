...
# component_id: S-208-governance-safety-checker
# component_layer: SKILL
# component_name: S 208 Governance Safety Checker
...
# evidence_used_for_resolution: path/pre-contract keyword: quality/governance; component_path=skills/script_intelligence/S-208-governance-safety-checker.py; component_id=S-208-governance-safety-checker
