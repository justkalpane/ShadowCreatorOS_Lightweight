# SKL-PH1-AUDIENCE-ALIGNMENT-MAPPER

## 1. Skill Identity
- **Skill ID:** S-209
- **Skill Name:** Audience Alignment Mapper
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for S-209 (Audience Alignment Mapper). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** audience-alignment-mapper_executor
...
- **Downstream Handoff:** audience-alignment-mapper_packet -> downstream workflow chain
...
```json
{
  ...
  "artifact_family": "audience-alignment-mapper_packet",
  ...
  "payload": {
    "skill_id": "S-209",
    "skill_name": "Audience Alignment Mapper",
    "result": {}
  }
}
```
...
**Write Targets:**
- dossier.narrative_vein.audience-alignment-mapper (append_to_array)
...
**Writes:**
- dossier.narrative_vein.audience-alignment-mapper (append_only)
...
component_id: S-209-audience-alignment-mapper.skill
component_layer: SKILL
component_name: S 209 Audience Alignment Mapper.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/script_intelligence/S-209-audience-alignment-mapper.skill.md; component_id=S-209-audience-alignment-mapper.skill
