...
# component_id: S-210-final-script-packager
# component_layer: SKILL
# component_name: S 210 Final Script Packager
# route_families: [script_refinement, script_generation]
# activation_triggers: route_family in [script_generation, editing_packaging] or explicit registry selection; mark script_refinement_profile only when route_family is unknown.
...
# input_schema: Must declare atomic input fields before use; script_refinement_profile if absent upstream.
