...
# component_id: S-210-script-compression-engine
# component_layer: SKILL
# component_name: S 210 Script Compression Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence/S-210-script-compression-engine.py; component_id=S-210-script-compression-engine
