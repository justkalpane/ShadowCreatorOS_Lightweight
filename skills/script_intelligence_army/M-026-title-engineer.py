...
# component_id: M-026-title-engineer
# component_layer: SKILL
# component_name: M 026 Title Engineer
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-026-title-engineer.py; component_id=M-026-title-engineer
