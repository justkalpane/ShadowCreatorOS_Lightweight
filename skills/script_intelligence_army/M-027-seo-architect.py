...
# component_id: M-027-seo-architect
# component_layer: SKILL
# component_name: M 027 Seo Architect
...
# evidence_used_for_resolution: path/pre-contract keyword: editing/packaging/platform; component_path=skills/script_intelligence_army/M-027-seo-architect.py; component_id=M-027-seo-architect
