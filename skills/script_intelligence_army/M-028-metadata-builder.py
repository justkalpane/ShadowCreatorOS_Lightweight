...
# component_id: M-028-metadata-builder
# component_layer: SKILL
# component_name: M 028 Metadata Builder
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-028-metadata-builder.py; component_id=M-028-metadata-builder
