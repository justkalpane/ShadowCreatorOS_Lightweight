...
# component_id: M-029-audience-analyzer
# component_layer: SKILL
# component_name: M 029 Audience Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-029-audience-analyzer.py; component_id=M-029-audience-analyzer
