...
# component_id: M-030-engagement-predictor
# component_layer: SKILL
# component_name: M 030 Engagement Predictor
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-030-engagement-predictor.py; component_id=M-030-engagement-predictor
