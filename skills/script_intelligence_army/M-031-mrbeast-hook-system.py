...
# component_id: M-031-mrbeast-hook-system
# component_layer: SKILL
# component_name: M 031 Mrbeast Hook System
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-031-mrbeast-hook-system.py; component_id=M-031-mrbeast-hook-system
