...
# component_id: M-032-pattern-interrupt-engine
# component_layer: SKILL
# component_name: M 032 Pattern Interrupt Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-032-pattern-interrupt-engine.py; component_id=M-032-pattern-interrupt-engine
