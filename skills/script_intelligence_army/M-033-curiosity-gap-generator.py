...
# component_id: M-033-curiosity-gap-generator
# component_layer: SKILL
# component_name: M 033 Curiosity Gap Generator
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-033-curiosity-gap-generator.py; component_id=M-033-curiosity-gap-generator
