...
- Upstream Dependencies: M-032
- Downstream Consumers: M-034
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic curiosity gap generator outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-033 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.curiosity_gap_generator with append-only write intent.
...
5. Execute deterministic transformation graph for curiosity_gap_generator.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m033_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m033_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m033_packet
- JSON Schema Reference: schemas/packets/m033_packet.schema.json
- Dossier Write Target: dossier.script_vein.curiosity_gap_generator
...
## 12. Validation/Done
- TEST-M-033-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-033-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-033_Curiosity_Gap_Generator
component_layer: SKILL
component_name: M 033 Curiosity Gap Generator.Skill
