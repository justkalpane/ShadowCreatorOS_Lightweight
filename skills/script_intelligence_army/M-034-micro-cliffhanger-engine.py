...
# component_id: M-034-micro-cliffhanger-engine
# component_layer: SKILL
# component_name: M 034 Micro Cliffhanger Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-034-micro-cliffhanger-engine.py; component_id=M-034-micro-cliffhanger-engine
