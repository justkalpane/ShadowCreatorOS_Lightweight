...
# 70-90 seconds unless the script packet carries a topic-specific reason.



# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: M-035-engagement-loop-builder
# component_layer: SKILL
# component_name: M 035 Engagement Loop Builder
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-035-engagement-loop-builder.py; component_id=M-035-engagement-loop-builder
