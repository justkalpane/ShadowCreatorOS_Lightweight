...
# component_id: M-036-emotional-spike-system
# component_layer: SKILL
# component_name: M 036 Emotional Spike System
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/script_intelligence_army/M-036-emotional-spike-system.py; component_id=M-036-emotional-spike-system
