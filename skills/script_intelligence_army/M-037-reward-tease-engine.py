...
# component_id: M-037-reward-tease-engine
# component_layer: SKILL
# component_name: M 037 Reward Tease Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-037-reward-tease-engine.py; component_id=M-037-reward-tease-engine
