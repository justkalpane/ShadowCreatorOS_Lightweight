...
# component_id: M-038-payoff-delivery-system
# component_layer: SKILL
# component_name: M 038 Payoff Delivery System
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-038-payoff-delivery-system.py; component_id=M-038-payoff-delivery-system
