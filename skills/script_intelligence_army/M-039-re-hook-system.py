...
# component_id: M-039-re-hook-system
# component_layer: SKILL
# component_name: M 039 Re Hook System
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-039-re-hook-system.py; component_id=M-039-re-hook-system
