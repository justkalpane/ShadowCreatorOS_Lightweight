...
# component_id: M-040-story-momentum-engine
# component_layer: SKILL
# component_name: M 040 Story Momentum Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-040-story-momentum-engine.py; component_id=M-040-story-momentum-engine
