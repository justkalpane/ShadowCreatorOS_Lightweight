...
# component_id: M-041-scene-energy-analyzer
# component_layer: SKILL
# component_name: M 041 Scene Energy Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/script_intelligence_army/M-041-scene-energy-analyzer.py; component_id=M-041-scene-energy-analyzer
