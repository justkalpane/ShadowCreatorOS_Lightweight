...
- Upstream Dependencies: M-040
- Downstream Consumers: M-042
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic scene energy analyzer outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-041 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.scene_energy_analyzer with append-only write intent.
...
5. Execute deterministic transformation graph for scene_energy_analyzer.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m041_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m041_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m041_packet
- JSON Schema Reference: schemas/packets/m041_packet.schema.json
- Dossier Write Target: dossier.script_vein.scene_energy_analyzer
...
## 12. Validation/Done
- TEST-M-041-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-041-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-041_Scene_Energy_Analyzer
component_layer: SKILL
component_name: M 041 Scene Energy Analyzer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/script_intelligence_army/M-041-scene-energy-analyzer.skill.md; component_id=M-041_Scene_Energy_Analyzer
