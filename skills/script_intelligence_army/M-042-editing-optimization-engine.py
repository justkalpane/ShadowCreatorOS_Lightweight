...
# component_id: M-042-editing-optimization-engine
# component_layer: SKILL
# component_name: M 042 Editing Optimization Engine
# route_families: [editing_packaging, full_video_pipeline, publishing]
# activation_triggers: route_family in [script_generation, editing_packaging] or explicit registry selection; mark media_quality_gate_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: editing/packaging/platform; component_path=skills/script_intelligence_army/M-042-editing-optimization-engine.py; component_id=M-042-editing-optimization-engine
