...
# component_id: M-043-cut-acceleration-system
# component_layer: SKILL
# component_name: M 043 Cut Acceleration System
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-043-cut-acceleration-system.py; component_id=M-043-cut-acceleration-system
