...
# component_id: M-044-visual-impact-engine
# component_layer: SKILL
# component_name: M 044 Visual Impact Engine
# route_families: [visual_context, context_engineering, image_generation]
# activation_triggers: route_family in [script_generation, visual_context] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: visual/image/design; component_path=skills/script_intelligence_army/M-044-visual-impact-engine.py; component_id=M-044-visual-impact-engine
