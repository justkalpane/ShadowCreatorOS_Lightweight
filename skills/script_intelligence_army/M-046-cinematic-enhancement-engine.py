...
# component_id: M-046-cinematic-enhancement-engine
# component_layer: SKILL
# component_name: M 046 Cinematic Enhancement Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/script_intelligence_army/M-046-cinematic-enhancement-engine.py; component_id=M-046-cinematic-enhancement-engine
