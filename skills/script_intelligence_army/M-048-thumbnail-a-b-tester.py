...
# component_id: M-048-thumbnail-a-b-tester
# component_layer: SKILL
# component_name: M 048 Thumbnail A B Tester
...
# evidence_used_for_resolution: path/pre-contract keyword: editing/packaging/platform; component_path=skills/script_intelligence_army/M-048-thumbnail-a-b-tester.py; component_id=M-048-thumbnail-a-b-tester
