...
# component_id: M-049-viral-distribution-planner
# component_layer: SKILL
# component_name: M 049 Viral Distribution Planner
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-049-viral-distribution-planner.py; component_id=M-049-viral-distribution-planner
