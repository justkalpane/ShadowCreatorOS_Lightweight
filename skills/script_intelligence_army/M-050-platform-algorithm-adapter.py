...
# component_id: M-050-platform-algorithm-adapter
# component_layer: SKILL
# component_name: M 050 Platform Algorithm Adapter
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-050-platform-algorithm-adapter.py; component_id=M-050-platform-algorithm-adapter
