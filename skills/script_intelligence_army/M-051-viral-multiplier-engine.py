...
# component_id: M-051-viral-multiplier-engine
# component_layer: SKILL
# component_name: M 051 Viral Multiplier Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-051-viral-multiplier-engine.py; component_id=M-051-viral-multiplier-engine
