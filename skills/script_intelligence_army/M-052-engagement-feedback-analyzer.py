...
# component_id: M-052-engagement-feedback-analyzer
# component_layer: SKILL
# component_name: M 052 Engagement Feedback Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-052-engagement-feedback-analyzer.py; component_id=M-052-engagement-feedback-analyzer
