...
# component_id: M-053-audience-sentiment-engine
# component_layer: SKILL
# component_name: M 053 Audience Sentiment Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-053-audience-sentiment-engine.py; component_id=M-053-audience-sentiment-engine
