...
# component_id: M-054-content-optimization-engine
# component_layer: SKILL
# component_name: M 054 Content Optimization Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: refinement/optimization; component_path=skills/script_intelligence_army/M-054-content-optimization-engine.py; component_id=M-054-content-optimization-engine
