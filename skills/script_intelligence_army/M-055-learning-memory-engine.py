...
# component_id: M-055-learning-memory-engine
# component_layer: SKILL
# component_name: M 055 Learning Memory Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-055-learning-memory-engine.py; component_id=M-055-learning-memory-engine
