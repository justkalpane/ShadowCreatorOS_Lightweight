...
# component_id: M-056-growth-prediction-engine
# component_layer: SKILL
# component_name: M 056 Growth Prediction Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-056-growth-prediction-engine.py; component_id=M-056-growth-prediction-engine
