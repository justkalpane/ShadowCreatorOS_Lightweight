...
# component_id: M-057-monetization-advisor
# component_layer: SKILL
# component_name: M 057 Monetization Advisor
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-057-monetization-advisor.py; component_id=M-057-monetization-advisor
