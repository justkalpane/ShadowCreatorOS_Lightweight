...
# component_id: M-058-sponsorship-matchmaker
# component_layer: SKILL
# component_name: M 058 Sponsorship Matchmaker
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-058-sponsorship-matchmaker.py; component_id=M-058-sponsorship-matchmaker
