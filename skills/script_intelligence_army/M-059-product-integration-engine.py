...
# component_id: M-059-product-integration-engine
# component_layer: SKILL
# component_name: M 059 Product Integration Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-059-product-integration-engine.py; component_id=M-059-product-integration-engine
