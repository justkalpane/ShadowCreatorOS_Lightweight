...
# component_id: M-060-channel-strategy-director
# component_layer: SKILL
# component_name: M 060 Channel Strategy Director
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/script_intelligence_army/M-060-channel-strategy-director.py; component_id=M-060-channel-strategy-director
