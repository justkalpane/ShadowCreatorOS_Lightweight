...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-101",
            "artifact_family": "elevenlabs-voice-generation-optimizer_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-101",
        "sub_skill_name": "ElevenLabs Voice Generation Optimizer",
        "artifact_family": "elevenlabs-voice-generation-optimizer_packet",
        "created_at": now,
...
# component_id: SS-101-elevenlabs-voice-generation-optimizer
# component_layer: SKILL
# component_name: Ss 101 Elevenlabs Voice Generation Optimizer
# route_families: [provider_handoff, full_video_pipeline]
# activation_triggers: route_family in [voice_context] or explicit registry selection; mark provider_handoff_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-101-elevenlabs-voice-generation-optimizer.py; component_id=SS-101-elevenlabs-voice-generation-optimizer
