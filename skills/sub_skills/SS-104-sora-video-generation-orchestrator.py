...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        return {
            ...
            "sub_skill_id": "SS-104",
            "artifact_family": "sora-video-generation-orchestrator_packet",
            "payload": {},
        }
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-104",
        "sub_skill_name": "Sora Video Generation Orchestrator",
        "artifact_family": "sora-video-generation-orchestrator_packet",
        "created_at": now,
...
# component_id: SS-104-sora-video-generation-orchestrator
# component_layer: SKILL
# component_name: Ss 104 Sora Video Generation Orchestrator
# route_families: [provider_handoff, full_video_pipeline]
# activation_triggers: route_family in [avatar_video_context] or explicit registry selection; mark provider_handoff_profile only when route_family is unknown.
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-104-sora-video-generation-orchestrator.py; component_id=SS-104-sora-video-generation-orchestrator
