...
component_id: SS-114-yt-dlp-ingestion-compliance-guard.subskill
component_layer: SKILL
component_name: Ss 114 Yt Dlp Ingestion Compliance Guard.Subskill
route_families: [approval_gate, repo_write_mode]
activation_triggers: route_family in [script_generation, quality_gate] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: approval/oauth; component_path=skills/sub_skills/SS-114-yt-dlp-ingestion-compliance-guard.subskill.md; component_id=SS-114-yt-dlp-ingestion-compliance-guard.subskill
