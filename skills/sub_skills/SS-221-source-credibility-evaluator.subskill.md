...
component_id: SS-221-source-credibility-evaluator.subskill
component_layer: SKILL
component_name: Ss 221 Source Credibility Evaluator.Subskill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [trend_research, quality_gate, lineage_summary] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/sub_skills/SS-221-source-credibility-evaluator.subskill.md; component_id=SS-221-source-credibility-evaluator.subskill
