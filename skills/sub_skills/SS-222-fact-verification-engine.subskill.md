...
component_id: SS-222-fact-verification-engine.subskill
component_layer: SKILL
component_name: Ss 222 Fact Verification Engine.Subskill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [publishing, quality_gate, lineage_summary] or explicit registry selection; mark approval_gate_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/sub_skills/SS-222-fact-verification-engine.subskill.md; component_id=SS-222-fact-verification-engine.subskill
