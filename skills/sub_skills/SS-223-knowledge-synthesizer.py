...
# component_id: SS-223-knowledge-synthesizer
# component_layer: SKILL
# component_name: Ss 223 Knowledge Synthesizer
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-223-knowledge-synthesizer.py; component_id=SS-223-knowledge-synthesizer
