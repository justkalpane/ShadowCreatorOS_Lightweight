...
component_id: SS-224-contradiction-detector.subskill
component_layer: SKILL
component_name: Ss 224 Contradiction Detector.Subskill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/sub_skills/SS-224-contradiction-detector.subskill.md; component_id=SS-224-contradiction-detector.subskill
