...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-230",
        "sub_skill_name": "Content Angle Generator",
        "artifact_family": "content-angle-generator_packet",
        "created_at": now,
...
# component_id: SS-230-content-angle-generator
# component_layer: SKILL
# component_name: Ss 230 Content Angle Generator
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-230-content-angle-generator.py; component_id=SS-230-content-angle-generator
