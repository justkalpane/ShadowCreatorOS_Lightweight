...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-234",
        "sub_skill_name": "Platform Strategy Mapper",
        "artifact_family": "platform-strategy-mapper_packet",
        "created_at": now,
...
# component_id: SS-234-platform-strategy-mapper
# component_layer: SKILL
# component_name: Ss 234 Platform Strategy Mapper
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-234-platform-strategy-mapper.py; component_id=SS-234-platform-strategy-mapper
