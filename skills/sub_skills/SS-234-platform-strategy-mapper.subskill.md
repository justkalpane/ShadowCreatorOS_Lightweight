...
component_id: SS-234-platform-strategy-mapper.subskill
component_layer: SKILL
component_name: Ss 234 Platform Strategy Mapper.Subskill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/sub_skills/SS-234-platform-strategy-mapper.subskill.md; component_id=SS-234-platform-strategy-mapper.subskill
