...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-240",
        "sub_skill_name": "Hook Variation Generator",
        "artifact_family": "hook-variation-generator_packet",
        "created_at": now,
...
# component_id: SS-240-hook-variation-generator
# component_layer: SKILL
# component_name: Ss 240 Hook Variation Generator
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-240-hook-variation-generator.py; component_id=SS-240-hook-variation-generator
