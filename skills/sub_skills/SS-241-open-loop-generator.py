...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-241",
        "sub_skill_name": "Open Loop Generator",
        "artifact_family": "open-loop-generator_packet",
        "created_at": now,
...
# component_id: SS-241-open-loop-generator
# component_layer: SKILL
# component_name: Ss 241 Open Loop Generator
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-241-open-loop-generator.py; component_id=SS-241-open-loop-generator
