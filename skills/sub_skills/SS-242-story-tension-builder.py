...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-242",
        "sub_skill_name": "Story Tension Builder",
        "artifact_family": "story-tension-builder_packet",
        "created_at": now,
...
# component_id: SS-242-story-tension-builder
# component_layer: SKILL
# component_name: Ss 242 Story Tension Builder
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-242-story-tension-builder.py; component_id=SS-242-story-tension-builder
