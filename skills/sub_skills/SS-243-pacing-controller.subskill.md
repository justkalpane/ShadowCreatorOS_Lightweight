# SUBSKILL SS-243 - Pacing Controller

## SECTION 1: SKILL IDENTITY & OWNERSHIP
- Skill_ID: SS-243
- Canonical_Name: Pacing Controller
- Archetype: integration
- Role_Type: PRIMARY_ROLE
- Owner_Director: Kartikeya
- Domain: Pacing Control
...
### 3.2 Provider Context
  - internal_pacing_runtime

## SECTION 4: WRITES (OUTPUT VEINS)
- artifact_family:pacing-controller_packet
- pacing_plan:object
- pacing_heatmap:array
- status:success|failed|degraded
- write_target: dossier.subskills.pacing-controller (append_only)
...
- Control segment duration by retention risk profile
- Reduce dead air and low-yield transitions
- Align pacing to platform form factor
- Insert recovery beats after high-density segments
- Emit pacing heatmap for editor and QA
...
- pacing_spikes -> smooth segment timing
- overcompression -> restore clarity buffers
- platform_mismatch -> adjust profile preset
...
- packet_contract: pacing-controller_packet
- replay_path: WF-021
...
component_id: SS-243-pacing-controller.subskill
component_layer: SKILL
component_name: Ss 243 Pacing Controller.Subskill
