...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-244",
        "sub_skill_name": "Retention Loop Engine",
        "artifact_family": "retention-loop-engine_packet",
        "created_at": now,
...
# component_id: SS-244-retention-loop-engine
# component_layer: SKILL
# component_name: Ss 244 Retention Loop Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-244-retention-loop-engine.py; component_id=SS-244-retention-loop-engine
