...
def run(input_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "success",
        "sub_skill_id": "SS-245",
        "sub_skill_name": "Cliffhanger Designer",
        "artifact_family": "cliffhanger-designer_packet",
        "created_at": now,
...
# component_id: SS-245-cliffhanger-designer
# component_layer: SKILL
# component_name: Ss 245 Cliffhanger Designer
...
# evidence_used_for_resolution: path/pre-contract keyword: provider/tool adapter; component_path=skills/sub_skills/SS-245-cliffhanger-designer.py; component_id=SS-245-cliffhanger-designer
