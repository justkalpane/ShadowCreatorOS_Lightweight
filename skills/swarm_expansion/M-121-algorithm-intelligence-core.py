...
# component_id: M-121-algorithm-intelligence-core
# component_layer: SKILL
# component_name: M 121 Algorithm Intelligence Core
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-121-algorithm-intelligence-core.py; component_id=M-121-algorithm-intelligence-core
