...
## 7. Outputs
- Output Packet Family: m121_packet
- JSON Schema Reference: schemas/packets/m121_packet.schema.json
...
component_id: M-121-algorithm-intelligence-core.skill
component_layer: SKILL
component_name: M 121 Algorithm Intelligence Core.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/swarm_expansion/M-121-algorithm-intelligence-core.skill.md; component_id=M-121-algorithm-intelligence-core.skill
