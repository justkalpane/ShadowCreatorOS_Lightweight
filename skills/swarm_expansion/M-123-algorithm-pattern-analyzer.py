...
# component_id: M-123-algorithm-pattern-analyzer
# component_layer: SKILL
# component_name: M 123 Algorithm Pattern Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-123-algorithm-pattern-analyzer.py; component_id=M-123-algorithm-pattern-analyzer
