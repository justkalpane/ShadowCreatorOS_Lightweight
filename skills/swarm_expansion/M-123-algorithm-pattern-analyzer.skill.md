...
## 7. Outputs
- Output Packet Family: m123_packet
- JSON Schema Reference: schemas/packets/m123_packet.schema.json
...
component_id: M-123-algorithm-pattern-analyzer.skill
component_layer: SKILL
component_name: M 123 Algorithm Pattern Analyzer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/swarm_expansion/M-123-algorithm-pattern-analyzer.skill.md; component_id=M-123-algorithm-pattern-analyzer.skill
