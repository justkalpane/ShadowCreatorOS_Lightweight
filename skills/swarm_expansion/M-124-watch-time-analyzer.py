...
# component_id: M-124-watch-time-analyzer
# component_layer: SKILL
# component_name: M 124 Watch Time Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-124-watch-time-analyzer.py; component_id=M-124-watch-time-analyzer
