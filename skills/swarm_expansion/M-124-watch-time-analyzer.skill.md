...
component_id: M-124-watch-time-analyzer.skill
component_layer: SKILL
component_name: M 124 Watch Time Analyzer.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [script_generation, trend_research, voice_context, music_sfx_context] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/swarm_expansion/M-124-watch-time-analyzer.skill.md; component_id=M-124-watch-time-analyzer.skill
