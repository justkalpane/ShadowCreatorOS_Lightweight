...
# component_id: M-125-retention-drop-detector
# component_layer: SKILL
# component_name: M 125 Retention Drop Detector
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/swarm_expansion/M-125-retention-drop-detector.py; component_id=M-125-retention-drop-detector
