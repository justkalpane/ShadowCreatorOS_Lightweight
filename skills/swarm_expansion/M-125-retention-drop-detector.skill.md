...
component_id: M-125-retention-drop-detector.skill
component_layer: SKILL
component_name: M 125 Retention Drop Detector.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/swarm_expansion/M-125-retention-drop-detector.skill.md; component_id=M-125-retention-drop-detector.skill
