...
# component_id: M-126-retention-repair-engine
# component_layer: SKILL
# component_name: M 126 Retention Repair Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: refinement/optimization; component_path=skills/swarm_expansion/M-126-retention-repair-engine.py; component_id=M-126-retention-repair-engine
