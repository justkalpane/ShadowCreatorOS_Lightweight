...
# component_id: M-127-viral-pattern-library
# component_layer: SKILL
# component_name: M 127 Viral Pattern Library
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-127-viral-pattern-library.py; component_id=M-127-viral-pattern-library
