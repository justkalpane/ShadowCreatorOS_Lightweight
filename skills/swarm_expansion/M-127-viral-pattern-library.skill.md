...
## 7. Outputs
- Output Packet Family: m127_packet
- JSON Schema Reference: schemas/packets/m127_packet.schema.json
...
component_id: M-127-viral-pattern-library.skill
component_layer: SKILL
component_name: M 127 Viral Pattern Library.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/swarm_expansion/M-127-viral-pattern-library.skill.md; component_id=M-127-viral-pattern-library.skill
