...
# component_id: M-128-viral-pattern-replicator
# component_layer: SKILL
# component_name: M 128 Viral Pattern Replicator
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-128-viral-pattern-replicator.py; component_id=M-128-viral-pattern-replicator
