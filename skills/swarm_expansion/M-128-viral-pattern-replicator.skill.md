...
component_id: M-128-viral-pattern-replicator.skill
component_layer: SKILL
component_name: M 128 Viral Pattern Replicator.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/swarm_expansion/M-128-viral-pattern-replicator.skill.md; component_id=M-128-viral-pattern-replicator.skill
