...
# component_id: M-129-thumbnail-heatmap-analyzer
# component_layer: SKILL
# component_name: M 129 Thumbnail Heatmap Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: editing/packaging/platform; component_path=skills/swarm_expansion/M-129-thumbnail-heatmap-analyzer.py; component_id=M-129-thumbnail-heatmap-analyzer
