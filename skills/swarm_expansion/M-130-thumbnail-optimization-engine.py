...
# component_id: M-130-thumbnail-optimization-engine
# component_layer: SKILL
# component_name: M 130 Thumbnail Optimization Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: editing/packaging/platform; component_path=skills/swarm_expansion/M-130-thumbnail-optimization-engine.py; component_id=M-130-thumbnail-optimization-engine
