...
# component_id: M-131-ctr-prediction-engine
# component_layer: SKILL
# component_name: M 131 Ctr Prediction Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-131-ctr-prediction-engine.py; component_id=M-131-ctr-prediction-engine
