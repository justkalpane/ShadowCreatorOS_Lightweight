...
# component_id: M-132-title-emotion-analyzer
# component_layer: SKILL
# component_name: M 132 Title Emotion Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/swarm_expansion/M-132-title-emotion-analyzer.py; component_id=M-132-title-emotion-analyzer
