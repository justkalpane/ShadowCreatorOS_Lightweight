...
# component_id: M-133-curiosity-trigger-engine
# component_layer: SKILL
# component_name: M 133 Curiosity Trigger Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-133-curiosity-trigger-engine.py; component_id=M-133-curiosity-trigger-engine
