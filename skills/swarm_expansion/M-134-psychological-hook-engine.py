...
# component_id: M-134-psychological-hook-engine
# component_layer: SKILL
# component_name: M 134 Psychological Hook Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/swarm_expansion/M-134-psychological-hook-engine.py; component_id=M-134-psychological-hook-engine
