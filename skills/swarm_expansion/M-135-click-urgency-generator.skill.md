...
- Upstream Dependencies: M-134
- Downstream Consumers: M-136
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic click urgency generator outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-135 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.click_urgency_generator with append-only write intent.
...
5. Execute deterministic transformation graph for click_urgency_generator.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m135_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m135_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m135_packet
- JSON Schema Reference: schemas/packets/m135_packet.schema.json
- Dossier Write Target: dossier.script_vein.click_urgency_generator
...
## 12. Validation/Done
- TEST-M-135-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-135-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-135_Click_Urgency_Generator
component_layer: SKILL
component_name: M 135 Click Urgency Generator.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/swarm_expansion/M-135-click-urgency-generator.skill.md; component_id=M-135_Click_Urgency_Generator
