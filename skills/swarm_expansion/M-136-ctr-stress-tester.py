...
# component_id: M-136-ctr-stress-tester
# component_layer: SKILL
# component_name: M 136 Ctr Stress Tester
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-136-ctr-stress-tester.py; component_id=M-136-ctr-stress-tester
