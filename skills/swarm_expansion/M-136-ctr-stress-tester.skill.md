...
- Upstream Dependencies: M-135
- Downstream Consumers: M-137
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic ctr stress tester outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-136 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.ctr_stress_tester with append-only write intent.
...
5. Execute deterministic transformation graph for ctr_stress_tester.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m136_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m136_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m136_packet
- JSON Schema Reference: schemas/packets/m136_packet.schema.json
- Dossier Write Target: dossier.script_vein.ctr_stress_tester
...
## 12. Validation/Done
- TEST-M-136-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-136-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-136_Ctr_Stress_Tester
component_layer: SKILL
component_name: M 136 Ctr Stress Tester.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/swarm_expansion/M-136-ctr-stress-tester.skill.md; component_id=M-136_Ctr_Stress_Tester
