...
# component_id: M-137-thumbnail-emotion-optimizer
# component_layer: SKILL
# component_name: M 137 Thumbnail Emotion Optimizer
...
# evidence_used_for_resolution: path/pre-contract keyword: editing/packaging/platform; component_path=skills/swarm_expansion/M-137-thumbnail-emotion-optimizer.py; component_id=M-137-thumbnail-emotion-optimizer
