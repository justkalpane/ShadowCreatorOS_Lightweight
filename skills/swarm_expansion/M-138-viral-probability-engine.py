...
# component_id: M-138-viral-probability-engine
# component_layer: SKILL
# component_name: M 138 Viral Probability Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-138-viral-probability-engine.py; component_id=M-138-viral-probability-engine
