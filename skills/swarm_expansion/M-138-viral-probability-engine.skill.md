# M-138 Viral Probability Engine
...
- Upstream Dependencies: M-137
- Downstream Consumers: M-139
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic viral probability engine outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-138 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.viral_probability_engine with append-only write intent.
...
5. Execute deterministic transformation graph for viral_probability_engine.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m138_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m138_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m138_packet
- JSON Schema Reference: schemas/packets/m138_packet.schema.json
- Dossier Write Target: dossier.script_vein.viral_probability_engine
...
## 12. Validation/Done
- TEST-M-138-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-138-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-138_Viral_Probability_Engine
component_layer: SKILL
component_name: M 138 Viral Probability Engine.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/swarm_expansion/M-138-viral-probability-engine.skill.md; component_id=M-138_Viral_Probability_Engine
