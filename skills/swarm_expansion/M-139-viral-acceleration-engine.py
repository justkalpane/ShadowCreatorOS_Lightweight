...
# component_id: M-139-viral-acceleration-engine
# component_layer: SKILL
# component_name: M 139 Viral Acceleration Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-139-viral-acceleration-engine.py; component_id=M-139-viral-acceleration-engine
