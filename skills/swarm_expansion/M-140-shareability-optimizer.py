...
# component_id: M-140-shareability-optimizer
# component_layer: SKILL
# component_name: M 140 Shareability Optimizer
...
# evidence_used_for_resolution: path/pre-contract keyword: refinement/optimization; component_path=skills/swarm_expansion/M-140-shareability-optimizer.py; component_id=M-140-shareability-optimizer
