...
# component_id: M-141-community-trigger-engine
# component_layer: SKILL
# component_name: M 141 Community Trigger Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-141-community-trigger-engine.py; component_id=M-141-community-trigger-engine
