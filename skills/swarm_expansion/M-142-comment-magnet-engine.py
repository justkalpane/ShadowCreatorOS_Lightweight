...
# component_id: M-142-comment-magnet-engine
# component_layer: SKILL
# component_name: M 142 Comment Magnet Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-142-comment-magnet-engine.py; component_id=M-142-comment-magnet-engine
