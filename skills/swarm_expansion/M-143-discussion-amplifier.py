...
# component_id: M-143-discussion-amplifier
# component_layer: SKILL
# component_name: M 143 Discussion Amplifier
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-143-discussion-amplifier.py; component_id=M-143-discussion-amplifier
