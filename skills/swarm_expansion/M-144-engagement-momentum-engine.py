...
# component_id: M-144-engagement-momentum-engine
# component_layer: SKILL
# component_name: M 144 Engagement Momentum Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-144-engagement-momentum-engine.py; component_id=M-144-engagement-momentum-engine
