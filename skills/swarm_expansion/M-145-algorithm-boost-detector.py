...
# component_id: M-145-algorithm-boost-detector
# component_layer: SKILL
# component_name: M 145 Algorithm Boost Detector
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-145-algorithm-boost-detector.py; component_id=M-145-algorithm-boost-detector
