...
# component_id: M-146-viral-surge-manager
# component_layer: SKILL
# component_name: M 146 Viral Surge Manager
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-146-viral-surge-manager.py; component_id=M-146-viral-surge-manager
