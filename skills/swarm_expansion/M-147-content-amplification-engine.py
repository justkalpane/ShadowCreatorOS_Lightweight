...
# component_id: M-147-content-amplification-engine
# component_layer: SKILL
# component_name: M 147 Content Amplification Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-147-content-amplification-engine.py; component_id=M-147-content-amplification-engine
