...
# component_id: M-148-channel-authority-builder
# component_layer: SKILL
# component_name: M 148 Channel Authority Builder
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-148-channel-authority-builder.py; component_id=M-148-channel-authority-builder
