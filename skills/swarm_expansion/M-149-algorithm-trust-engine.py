...
# component_id: M-149-algorithm-trust-engine
# component_layer: SKILL
# component_name: M 149 Algorithm Trust Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-149-algorithm-trust-engine.py; component_id=M-149-algorithm-trust-engine
