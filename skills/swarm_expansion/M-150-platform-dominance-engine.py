...
# component_id: M-150-platform-dominance-engine
# component_layer: SKILL
# component_name: M 150 Platform Dominance Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/swarm_expansion/M-150-platform-dominance-engine.py; component_id=M-150-platform-dominance-engine
