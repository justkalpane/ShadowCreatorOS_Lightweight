...
# component_id: M-061-micro-skill-army-router
# component_layer: SKILL
# component_name: M 061 Micro Skill Army Router
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-061-micro-skill-army-router.py; component_id=M-061-micro-skill-army-router
