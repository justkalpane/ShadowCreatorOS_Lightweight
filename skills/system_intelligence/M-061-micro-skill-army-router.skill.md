...
- Upstream Dependencies: M-060
- Downstream Consumers: M-062
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic micro skill army router outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-061 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.micro_skill_army_router with append-only write intent.
...
5. Execute deterministic transformation graph for micro_skill_army_router.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m061_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m061_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m061_packet
- JSON Schema Reference: schemas/packets/m061_packet.schema.json
- Dossier Write Target: dossier.script_vein.micro_skill_army_router
...
## 12. Validation/Done
- TEST-M-061-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-061-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-061_Micro_Skill_Army_Router
component_layer: SKILL
component_name: M 061 Micro Skill Army Router.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-061-micro-skill-army-router.skill.md; component_id=M-061_Micro_Skill_Army_Router
