# M-063 Skill Dependency Resolver
...
- Strategic Authority Director: Ravana
- Upstream Dependencies: M-062
- Downstream Consumers: M-064
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic skill dependency resolver outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-063 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.skill_dependency_resolver with append-only write intent.
...
5. Execute deterministic transformation graph for skill_dependency_resolver.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m063_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m063_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m063_packet
- JSON Schema Reference: schemas/packets/m063_packet.schema.json
- Dossier Write Target: dossier.script_vein.skill_dependency_resolver
...
## 12. Validation/Done
- TEST-M-063-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-063-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-063_Skill_Dependency_Resolver
component_layer: SKILL
component_name: M 063 Skill Dependency Resolver.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-063-skill-dependency-resolver.skill.md; component_id=M-063_Skill_Dependency_Resolver
