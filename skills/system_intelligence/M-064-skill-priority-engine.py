...
# component_id: M-064-skill-priority-engine
# component_layer: SKILL
# component_name: M 064 Skill Priority Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-064-skill-priority-engine.py; component_id=M-064-skill-priority-engine
