...
- Upstream Dependencies: M-063
- Downstream Consumers: M-065
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic skill priority engine outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-064 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.skill_priority_engine with append-only write intent.
...
5. Execute deterministic transformation graph for skill_priority_engine.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m064_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m064_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m064_packet
- JSON Schema Reference: schemas/packets/m064_packet.schema.json
- Dossier Write Target: dossier.script_vein.skill_priority_engine
...
## 12. Validation/Done
- TEST-M-064-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-064-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-064_Skill_Priority_Engine
component_layer: SKILL
component_name: M 064 Skill Priority Engine.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-064-skill-priority-engine.skill.md; component_id=M-064_Skill_Priority_Engine
