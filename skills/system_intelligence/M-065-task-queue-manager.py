...
# component_id: M-065-task-queue-manager
# component_layer: SKILL
# component_name: M 065 Task Queue Manager
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-065-task-queue-manager.py; component_id=M-065-task-queue-manager
