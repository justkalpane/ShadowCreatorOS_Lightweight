...
- Upstream Dependencies: M-065
- Downstream Consumers: M-067
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic resource allocator outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-066 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.resource_allocator with append-only write intent.
...
5. Execute deterministic transformation graph for resource_allocator.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m066_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m066_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m066_packet
- JSON Schema Reference: schemas/packets/m066_packet.schema.json
- Dossier Write Target: dossier.script_vein.resource_allocator
...
## 12. Validation/Done
- TEST-M-066-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-066-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-066_Resource_Allocator
component_layer: SKILL
component_name: M 066 Resource Allocator.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-066-resource-allocator.skill.md; component_id=M-066_Resource_Allocator
