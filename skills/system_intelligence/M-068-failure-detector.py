...
# component_id: M-068-failure-detector
# component_layer: SKILL
# component_name: M 068 Failure Detector
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-068-failure-detector.py; component_id=M-068-failure-detector
