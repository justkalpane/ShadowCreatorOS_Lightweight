...
# component_id: M-069-recovery-engine
# component_layer: SKILL
# component_name: M 069 Recovery Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-069-recovery-engine.py; component_id=M-069-recovery-engine
