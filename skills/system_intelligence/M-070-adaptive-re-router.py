...
# component_id: M-070-adaptive-re-router
# component_layer: SKILL
# component_name: M 070 Adaptive Re Router
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-070-adaptive-re-router.py; component_id=M-070-adaptive-re-router
