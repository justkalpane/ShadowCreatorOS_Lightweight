...
# component_id: M-072-pattern-recognition-engine
# component_layer: SKILL
# component_name: M 072 Pattern Recognition Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-072-pattern-recognition-engine.py; component_id=M-072-pattern-recognition-engine
