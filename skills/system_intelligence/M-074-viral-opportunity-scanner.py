...
# component_id: M-074-viral-opportunity-scanner
# component_layer: SKILL
# component_name: M 074 Viral Opportunity Scanner
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-074-viral-opportunity-scanner.py; component_id=M-074-viral-opportunity-scanner
