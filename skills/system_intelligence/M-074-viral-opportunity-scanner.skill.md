# M-074 Viral Opportunity Scanner
...
- Upstream Dependencies: M-073
- Downstream Consumers: M-075
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic viral opportunity scanner outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-074 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.viral_opportunity_scanner with append-only write intent.
...
5. Execute deterministic transformation graph for viral_opportunity_scanner.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m074_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m074_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m074_packet
- JSON Schema Reference: schemas/packets/m074_packet.schema.json
- Dossier Write Target: dossier.script_vein.viral_opportunity_scanner
...
## 12. Validation/Done
- TEST-M-074-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-074-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-074_Viral_Opportunity_Scanner
component_layer: SKILL
component_name: M 074 Viral Opportunity Scanner.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-074-viral-opportunity-scanner.skill.md; component_id=M-074_Viral_Opportunity_Scanner
