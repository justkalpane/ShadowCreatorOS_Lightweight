...
# component_id: M-075-content-replication-engine
# component_layer: SKILL
# component_name: M 075 Content Replication Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-075-content-replication-engine.py; component_id=M-075-content-replication-engine
