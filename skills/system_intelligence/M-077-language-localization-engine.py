...
# component_id: M-077-language-localization-engine
# component_layer: SKILL
# component_name: M 077 Language Localization Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-077-language-localization-engine.py; component_id=M-077-language-localization-engine
