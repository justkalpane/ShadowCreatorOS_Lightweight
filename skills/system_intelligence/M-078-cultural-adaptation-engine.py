...
# component_id: M-078-cultural-adaptation-engine
# component_layer: SKILL
# component_name: M 078 Cultural Adaptation Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-078-cultural-adaptation-engine.py; component_id=M-078-cultural-adaptation-engine
