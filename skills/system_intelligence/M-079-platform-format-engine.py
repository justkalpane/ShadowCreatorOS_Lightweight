...
# component_id: M-079-platform-format-engine
# component_layer: SKILL
# component_name: M 079 Platform Format Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-079-platform-format-engine.py; component_id=M-079-platform-format-engine
