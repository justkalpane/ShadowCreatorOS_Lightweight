...
- Upstream Dependencies: M-078
- Downstream Consumers: M-080
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic platform format engine outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-079 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.platform_format_engine with append-only write intent.
...
5. Execute deterministic transformation graph for platform_format_engine.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m079_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m079_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m079_packet
- JSON Schema Reference: schemas/packets/m079_packet.schema.json
- Dossier Write Target: dossier.script_vein.platform_format_engine
...
## 12. Validation/Done
- TEST-M-079-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-079-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-079_Platform_Format_Engine
component_layer: SKILL
component_name: M 079 Platform Format Engine.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-079-platform-format-engine.skill.md; component_id=M-079_Platform_Format_Engine
