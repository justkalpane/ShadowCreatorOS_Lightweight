...
- Upstream Dependencies: M-079
- Downstream Consumers: M-081
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic shorts generator outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-080 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.shorts_generator with append-only write intent.
...
5. Execute deterministic transformation graph for shorts_generator.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m080_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m080_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m080_packet
- JSON Schema Reference: schemas/packets/m080_packet.schema.json
- Dossier Write Target: dossier.script_vein.shorts_generator
...
## 12. Validation/Done
- TEST-M-080-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-080-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-080_Shorts_Generator
component_layer: SKILL
component_name: M 080 Shorts Generator.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-080-shorts-generator.skill.md; component_id=M-080_Shorts_Generator
