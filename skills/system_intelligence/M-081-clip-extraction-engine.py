...
# component_id: M-081-clip-extraction-engine
# component_layer: SKILL
# component_name: M 081 Clip Extraction Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: script/hook/retention; component_path=skills/system_intelligence/M-081-clip-extraction-engine.py; component_id=M-081-clip-extraction-engine
