...
component_id: M-081_Clip_Extraction_Engine
component_layer: SKILL
component_name: M 081 Clip Extraction Engine.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-081-clip-extraction-engine.skill.md; component_id=M-081_Clip_Extraction_Engine
