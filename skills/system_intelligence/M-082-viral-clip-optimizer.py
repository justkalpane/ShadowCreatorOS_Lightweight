...
# component_id: M-082-viral-clip-optimizer
# component_layer: SKILL
# component_name: M 082 Viral Clip Optimizer
...
# evidence_used_for_resolution: path/pre-contract keyword: refinement/optimization; component_path=skills/system_intelligence/M-082-viral-clip-optimizer.py; component_id=M-082-viral-clip-optimizer
