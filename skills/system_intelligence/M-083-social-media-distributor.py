...
# component_id: M-083-social-media-distributor
# component_layer: SKILL
# component_name: M 083 Social Media Distributor
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-083-social-media-distributor.py; component_id=M-083-social-media-distributor
