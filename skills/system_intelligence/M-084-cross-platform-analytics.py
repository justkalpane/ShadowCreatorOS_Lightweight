...
# component_id: M-084-cross-platform-analytics
# component_layer: SKILL
# component_name: M 084 Cross Platform Analytics
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/system_intelligence/M-084-cross-platform-analytics.py; component_id=M-084-cross-platform-analytics
