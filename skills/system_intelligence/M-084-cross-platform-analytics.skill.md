...
component_id: M-084_Cross_Platform_Analytics
component_layer: SKILL
component_name: M 084 Cross Platform Analytics.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-084-cross-platform-analytics.skill.md; component_id=M-084_Cross_Platform_Analytics
