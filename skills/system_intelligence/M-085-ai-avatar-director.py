...
# component_id: M-085-ai-avatar-director
# component_layer: SKILL
# component_name: M 085 Ai Avatar Director
...
# evidence_used_for_resolution: path/pre-contract keyword: video/avatar/motion; component_path=skills/system_intelligence/M-085-ai-avatar-director.py; component_id=M-085-ai-avatar-director
