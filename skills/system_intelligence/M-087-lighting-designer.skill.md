...
- Upstream Dependencies: M-086
- Downstream Consumers: M-088
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic lighting designer outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-087 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.lighting_designer with append-only write intent.
...
5. Execute deterministic transformation graph for lighting_designer.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m087_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m087_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m087_packet
- JSON Schema Reference: schemas/packets/m087_packet.schema.json
- Dossier Write Target: dossier.script_vein.lighting_designer
...
## 12. Validation/Done
- TEST-M-087-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-087-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-087_Lighting_Designer
component_layer: SKILL
component_name: M 087 Lighting Designer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-087-lighting-designer.skill.md; component_id=M-087_Lighting_Designer
