...
- Upstream Dependencies: M-088
- Downstream Consumers: M-090
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic motion director outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-089 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.script_vein.motion_director with append-only write intent.
...
5. Execute deterministic transformation graph for motion_director.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m089_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m089_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m089_packet
- JSON Schema Reference: schemas/packets/m089_packet.schema.json
- Dossier Write Target: dossier.script_vein.motion_director
...
## 12. Validation/Done
- TEST-M-089-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-089-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-089_Motion_Director
component_layer: SKILL
component_name: M 089 Motion Director.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/system_intelligence/M-089-motion-director.skill.md; component_id=M-089_Motion_Director
