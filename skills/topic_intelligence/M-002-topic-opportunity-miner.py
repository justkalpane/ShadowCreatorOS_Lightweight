...
# component_id: M-002-topic-opportunity-miner
# component_layer: SKILL
# component_name: M 002 Topic Opportunity Miner
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/topic_intelligence/M-002-topic-opportunity-miner.py; component_id=M-002-topic-opportunity-miner
