...
- Upstream Dependencies: M-002
- Downstream Consumers: M-004
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic keyword intelligence miner outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-003 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.keyword_intelligence_miner with append-only write intent.
...
5. Execute deterministic transformation graph for keyword_intelligence_miner.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m003_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m003_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m003_packet
- JSON Schema Reference: schemas/packets/m003_packet.schema.json
- Dossier Write Target: dossier.research_vein.keyword_intelligence_miner
...
## 12. Validation/Done
- TEST-M-003-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-003-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-003_Keyword_Intelligence_Miner
component_layer: SKILL
component_name: M 003 Keyword Intelligence Miner.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/topic_intelligence/M-003-keyword-intelligence-miner.skill.md; component_id=M-003_Keyword_Intelligence_Miner
