...
# component_id: M-006-viral-pattern-detector
# component_layer: SKILL
# component_name: M 006 Viral Pattern Detector
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/topic_intelligence/M-006-viral-pattern-detector.py; component_id=M-006-viral-pattern-detector
