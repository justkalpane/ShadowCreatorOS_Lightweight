...
- Upstream Dependencies: M-004
- Downstream Consumers: M-007
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic viral pattern detector outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-006 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.viral_pattern_detector with append-only write intent.
...
5. Execute deterministic transformation graph for viral_pattern_detector.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m006_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m006_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m006_packet
- JSON Schema Reference: schemas/packets/m006_packet.schema.json
- Dossier Write Target: dossier.research_vein.viral_pattern_detector
...
## 12. Validation/Done
- TEST-M-006-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-006-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-006_Viral_Pattern_Detector
component_layer: SKILL
component_name: M 006 Viral Pattern Detector.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/topic_intelligence/M-006-viral-pattern-detector.skill.md; component_id=M-006_Viral_Pattern_Detector
