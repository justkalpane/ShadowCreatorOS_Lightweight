...
# component_id: M-007-algorithm-signal-monitor
# component_layer: SKILL
# component_name: M 007 Algorithm Signal Monitor
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/topic_intelligence/M-007-algorithm-signal-monitor.py; component_id=M-007-algorithm-signal-monitor
