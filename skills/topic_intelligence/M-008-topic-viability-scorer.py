...
# component_id: M-008-topic-viability-scorer
# component_layer: SKILL
# component_name: M 008 Topic Viability Scorer
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/topic_intelligence/M-008-topic-viability-scorer.py; component_id=M-008-topic-viability-scorer
