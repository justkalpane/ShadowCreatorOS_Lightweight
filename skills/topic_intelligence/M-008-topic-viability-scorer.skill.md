...
- Upstream Dependencies: M-007
- Downstream Consumers: M-009
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic topic viability scorer outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-008 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.topic_viability_scorer with append-only write intent.
...
5. Execute deterministic transformation graph for topic_viability_scorer.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m008_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m008_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m008_packet
- JSON Schema Reference: schemas/packets/m008_packet.schema.json
- Dossier Write Target: dossier.research_vein.topic_viability_scorer
...
## 12. Validation/Done
- TEST-M-008-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-008-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-008_Topic_Viability_Scorer
component_layer: SKILL
component_name: M 008 Topic Viability Scorer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/topic_intelligence/M-008-topic-viability-scorer.skill.md; component_id=M-008_Topic_Viability_Scorer
