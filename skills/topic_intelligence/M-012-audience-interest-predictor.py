...
# component_id: M-012-audience-interest-predictor
# component_layer: SKILL
# component_name: M 012 Audience Interest Predictor
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/topic_intelligence/M-012-audience-interest-predictor.py; component_id=M-012-audience-interest-predictor
