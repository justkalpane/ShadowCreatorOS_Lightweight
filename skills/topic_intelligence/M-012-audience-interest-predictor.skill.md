# M-012 Audience Interest Predictor
...
- Upstream Dependencies: M-011
- Downstream Consumers: M-013
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic audience interest predictor outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-012 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.audience_interest_predictor with append-only write intent.
...
5. Execute deterministic transformation graph for audience_interest_predictor.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m012_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m012_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m012_packet
- JSON Schema Reference: schemas/packets/m012_packet.schema.json
- Dossier Write Target: dossier.research_vein.audience_interest_predictor
...
## 12. Validation/Done
- TEST-M-012-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-012-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-012_Audience_Interest_Predictor
component_layer: SKILL
component_name: M 012 Audience Interest Predictor.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/topic_intelligence/M-012-audience-interest-predictor.skill.md; component_id=M-012_Audience_Interest_Predictor
