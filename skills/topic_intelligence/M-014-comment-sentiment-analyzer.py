...
# component_id: M-014-comment-sentiment-analyzer
# component_layer: SKILL
# component_name: M 014 Comment Sentiment Analyzer
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/topic_intelligence/M-014-comment-sentiment-analyzer.py; component_id=M-014-comment-sentiment-analyzer
