# M-015 Cultural Context Analyzer
...
- Upstream Dependencies: M-014
- Downstream Consumers: M-016
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic cultural context analyzer outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-015 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.cultural_context_analyzer with append-only write intent.
...
5. Execute deterministic transformation graph for cultural_context_analyzer.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m015_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m015_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m015_packet
- JSON Schema Reference: schemas/packets/m015_packet.schema.json
- Dossier Write Target: dossier.research_vein.cultural_context_analyzer
...
## 12. Validation/Done
- TEST-M-015-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-015-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-015_Cultural_Context_Analyzer
component_layer: SKILL
component_name: M 015 Cultural Context Analyzer.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/topic_intelligence/M-015-cultural-context-analyzer.skill.md; component_id=M-015_Cultural_Context_Analyzer
