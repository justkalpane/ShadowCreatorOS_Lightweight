...
# component_id: M-016-content-gap-finder
# component_layer: SKILL
# component_name: M 016 Content Gap Finder
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/topic_intelligence/M-016-content-gap-finder.py; component_id=M-016-content-gap-finder
