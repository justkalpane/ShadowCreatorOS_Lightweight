...
- Upstream Dependencies: M-015
- Downstream Consumers: M-018
- Escalation Path: WF-900
- Replay Path: WF-021

## 2. Purpose
Deliver deterministic content gap finder outputs for governed workflow progression without dossier overwrite behavior.
...
## 6. Execution Logic
1. Resolve skill registry row for M-016 and validate deterministic runtime prerequisites.
2. Load dossier namespace target dossier.research_vein.content_gap_finder with append-only write intent.
...
5. Execute deterministic transformation graph for content_gap_finder.
6. A. Compute quality, governance, and confidence checks.
   B. Fail fast to WF-900 if any hard gate is violated.
7. Build typed output packet m016_packet with schema version lock.
8. Validate packet envelope and payload against schemas/packets/m016_packet.schema.json.
...
## 7. Outputs
- Output Packet Family: m016_packet
- JSON Schema Reference: schemas/packets/m016_packet.schema.json
- Dossier Write Target: dossier.research_vein.content_gap_finder
...
## 12. Validation/Done
- TEST-M-016-001: Deterministic contract case 001 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-002: Deterministic contract case 002 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-003: Deterministic contract case 003 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-004: Deterministic contract case 004 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-005: Deterministic contract case 005 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-006: Deterministic contract case 006 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-007: Deterministic contract case 007 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-008: Deterministic contract case 008 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-009: Deterministic contract case 009 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-010: Deterministic contract case 010 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-011: Deterministic contract case 011 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-012: Deterministic contract case 012 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-013: Deterministic contract case 013 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-014: Deterministic contract case 014 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-015: Deterministic contract case 015 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-016: Deterministic contract case 016 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-017: Deterministic contract case 017 passes with WF-900/WF-021 governance preserved.
- TEST-M-016-018: Deterministic contract case 018 passes with WF-900/WF-021 governance preserved.
...
component_id: M-016_Content_Gap_Finder
component_layer: SKILL
component_name: M 016 Content Gap Finder.Skill
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/topic_intelligence/M-016-content-gap-finder.skill.md; component_id=M-016_Content_Gap_Finder
