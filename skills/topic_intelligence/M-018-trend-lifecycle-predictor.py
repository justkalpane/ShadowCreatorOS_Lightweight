...
# component_id: M-018-trend-lifecycle-predictor
# component_layer: SKILL
# component_name: M 018 Trend Lifecycle Predictor
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/topic_intelligence/M-018-trend-lifecycle-predictor.py; component_id=M-018-trend-lifecycle-predictor
