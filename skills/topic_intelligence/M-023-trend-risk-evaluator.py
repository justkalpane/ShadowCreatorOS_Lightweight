...
# component_id: M-023-trend-risk-evaluator
# component_layer: SKILL
# component_name: M 023 Trend Risk Evaluator
...
# evidence_used_for_resolution: path/pre-contract keyword: quality/governance; component_path=skills/topic_intelligence/M-023-trend-risk-evaluator.py; component_id=M-023-trend-risk-evaluator
