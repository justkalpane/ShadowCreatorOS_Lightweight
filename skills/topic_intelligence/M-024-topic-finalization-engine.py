...
# component_id: M-024-topic-finalization-engine
# component_layer: SKILL
# component_name: M 024 Topic Finalization Engine
...
# evidence_used_for_resolution: path/pre-contract keyword: research/source/fact; component_path=skills/topic_intelligence/M-024-topic-finalization-engine.py; component_id=M-024-topic-finalization-engine
