...
component_id: M-024-topic-finalization-engine.skill
component_layer: SKILL
component_name: M 024 Topic Finalization Engine.Skill
route_families: [lineage_summary, approval_gate]
activation_triggers: route_family in [trend_research, topic_discovery, lineage_summary] or explicit registry selection; mark lineage_profile only when route_family is unknown.
...
evidence_used_for_resolution: path/pre-contract keyword: lineage/trace; component_path=skills/topic_intelligence/M-024-topic-finalization-engine.skill.md; component_id=M-024-topic-finalization-engine.skill
