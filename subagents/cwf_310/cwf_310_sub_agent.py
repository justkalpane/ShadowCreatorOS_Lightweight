...
class Cwf310SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Cwf310SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: cwf_310_sub_agent
# component_layer: SUB_AGENT
# component_name: Cwf 310 Sub Agent
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/cwf_310/cwf_310_sub_agent.py; component_id=cwf_310_sub_agent
