...
class Cwf340SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Cwf340SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: cwf_340_sub_agent
# component_layer: SUB_AGENT
# component_name: Cwf 340 Sub Agent
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/cwf_340/cwf_340_sub_agent.py; component_id=cwf_340_sub_agent
