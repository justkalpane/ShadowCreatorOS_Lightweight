...
class Cwf410SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Cwf410SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: cwf_410_sub_agent
# component_layer: SUB_AGENT
# component_name: Cwf 410 Sub Agent
# route_families: [avatar_video_context, media_factory_handoff, visual_media_plan, media_factory_final_draft, context_engineering, general_support]
...
# route_family_resolved: [avatar_video_context, media_factory_handoff, visual_media_plan, media_factory_final_draft, context_engineering, general_support]
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/cwf_410/cwf_410_sub_agent.py; component_id=cwf_410_sub_agent
