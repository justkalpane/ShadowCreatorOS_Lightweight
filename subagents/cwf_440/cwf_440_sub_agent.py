...
class Cwf440SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Cwf440SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: cwf_440_sub_agent
# component_layer: SUB_AGENT
# component_name: Cwf 440 Sub Agent
# route_families: [avatar_video_context, non_content_technical_task, general_support]
...
# route_family_resolved: [avatar_video_context, non_content_technical_task, general_support]
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/cwf_440/cwf_440_sub_agent.py; component_id=cwf_440_sub_agent
