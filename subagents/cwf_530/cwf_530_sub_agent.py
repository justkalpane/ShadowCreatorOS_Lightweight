...
class Cwf530SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Cwf530SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: cwf_530_sub_agent
# component_layer: SUB_AGENT
# component_name: Cwf 530 Sub Agent
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/cwf_530/cwf_530_sub_agent.py; component_id=cwf_530_sub_agent
