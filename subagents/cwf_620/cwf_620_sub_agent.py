...
class Cwf620SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Cwf620SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: cwf_620_sub_agent
# component_layer: SUB_AGENT
# component_name: Cwf 620 Sub Agent
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/cwf_620/cwf_620_sub_agent.py; component_id=cwf_620_sub_agent
