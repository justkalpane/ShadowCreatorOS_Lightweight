...
class Cwf630SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Cwf630SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: cwf_630_sub_agent
# component_layer: SUB_AGENT
# component_name: Cwf 630 Sub Agent
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/cwf_630/cwf_630_sub_agent.py; component_id=cwf_630_sub_agent
