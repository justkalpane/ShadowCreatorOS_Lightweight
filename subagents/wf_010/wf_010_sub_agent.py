...
class Wf010SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Wf010SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: wf_010_sub_agent
# component_layer: SUB_AGENT
# component_name: Wf 010 Sub Agent
# route_families: [full_video_pipeline, non_content_technical_task, general_support]
...
# route_family_resolved: [full_video_pipeline, non_content_technical_task, general_support]
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/wf_010/wf_010_sub_agent.py; component_id=wf_010_sub_agent
