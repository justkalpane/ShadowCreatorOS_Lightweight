...
class Wf021SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Wf021SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: wf_021_sub_agent
# component_layer: SUB_AGENT
# component_name: Wf 021 Sub Agent
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/wf_021/wf_021_sub_agent.py; component_id=wf_021_sub_agent
