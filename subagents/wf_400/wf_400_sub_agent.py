...
class Wf400SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/wf_400/wf_400_sub_agent.py; component_id=wf_400_sub_agent
