...
class Wf600SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Wf600SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: wf_600_sub_agent
# component_layer: SUB_AGENT
# component_name: Wf 600 Sub Agent
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/wf_600/wf_600_sub_agent.py; component_id=wf_600_sub_agent
