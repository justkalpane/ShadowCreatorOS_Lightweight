...
class Wf900SubAgent(WorkflowSubAgentBase):
    def __init__(
        self,
...
if __name__ == "__main__":
    print_run(Wf900SubAgent())

# MAC-06.2B UNIVERSAL COMPONENT CONTRACT UPGRADE
# Append-only MAC-06.2B contract metadata.
# component_id: wf_900_sub_agent
# component_layer: SUB_AGENT
# component_name: Wf 900 Sub Agent
...
# evidence_used_for_resolution: fallback: cross-route support component; component_path=subagents/wf_900/wf_900_sub_agent.py; component_id=wf_900_sub_agent
